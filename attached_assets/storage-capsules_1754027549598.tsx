...
export default function StorageCapsules() {
  const options = [
    { size: '64GB', costUSD: 4.00 },
    { size: '128GB', costUSD: 7.50 },
    { size: '256GB', costUSD: 13.00 },
    { size: '512GB', costUSD: 24.00 },
    { size: '1TB', costUSD: 46.00 },
    { size: '2TB', costUSD: 90.00 }
  ];

  return (
    <div className="p-8">
      <section className="mb-12">
        <h1 className="text-4xl font-bold mb-4">📸 Secure Capsule Storage for Life</h1>
          ...
          {options.map(({ size, costUSD }, i) => {
            ...
            return (
              <div key={i} className="border p-6 rounded shadow">
                ...
                <p className="text-sm text-gray-600 mb-2">Permanent on-chain storage</p>
      ...
      <section className="mt-16 bg-indigo-50 p-6 rounded-xl">
        <h2 className="text-2xl font-bold mb-2">📦 Why Choose Guardian Capsules?</h2>
