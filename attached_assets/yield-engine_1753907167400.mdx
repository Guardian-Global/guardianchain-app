...
<Callout type="impact" icon="📈">
  <b>
    GuardianChain’s Yield Engine is the world’s first protocol for programmable,
    proof-bound, and fully auditable economic rewards—available to all
    contributors and validated by AI.
  </b>
</Callout>
- All rewards are algorithmic, on-chain, and governed by the DAO - Instant,
role-aware feedback and simulation for yield scenarios
...
<AnimatedChart src="/media/yield-flow-chart.svg" interactive />- **Capsule
Authors:** Earn GTT for high-quality, demand-driven memory capsules -
...
<YieldSimulator />- Choose your role, input activity, and see real-time reward
estimates - Compare validator, author, and community scenarios
...
<FAQ>
  <Question q="How is yield calculated?">
    Based on capsule quality, validator uptime, network demand, and DAO-set
    parameters. See simulator above.
  </Question>
  <Question q="Can I suggest changes?">
    Yes. Use the DAO proposal tool, or submit feedback in the chat overlay.
  </Question>
  <Question q="Is all data public?">
    Yes. Every reward, penalty, and distribution is on-chain and can be searched
    or exported.
  </Question>
  <Question q="Are there risks to yield?">
    All risks (slashing, penalty, parameter change) are shown in real time and
    are DAO governed.
  </Question>
</FAQ>
