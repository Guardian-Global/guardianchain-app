...
<Callout type="impact" icon="💎">
  <b>
    GuardianChain’s Sovereign Asset Ledger is a fully public, DAO-audited, and
...
<Callout type="pro" icon="📊">
  Filter by type, jurisdiction, owner class, or DAO status — export as PDF, CSV,
...
<FAQ>
  <Question q="Who can view the ledger?">
    Everyone—users, institutions, regulators, and the public (open data, no
    permission required).
  </Question>
  <Question q="How do I verify an asset’s status?">
    Click any asset or event for its chain-linked, certified, and time-stamped
    record.
  </Question>
  <Question q="Can I submit corrections or disputes?">
    Yes—via the DAO, dispute overlay, or open proposal process.
  </Question>
</FAQ>
