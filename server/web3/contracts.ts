...
export const GTT_YIELD_VAULT_ABI = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "griefTier", type: "uint256" }],
    name: "claimYield",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
...
export const CONTRACT_CONFIG = {
  ...
  GTT_YIELD_VAULT_ADDRESS:
    process.env.GTT_YIELD_VAULT_ADDRESS ||
    "0x0000000000000000000000000000000000000000",
  GTT_TOKEN_ADDRESS:
    process.env.GTT_TOKEN_ADDRESS ||
    "0x0000000000000000000000000000000000000000",
  CAPSULE_NFT_ADDRESS:
    process.env.CAPSULE_NFT_ADDRESS ||
    "0x0000000000000000000000000000000000000000",
...
export function getYieldVaultContract(
...
export class GTTYieldVaultService {
  ...
  async claimYield(griefTier: number): Promise<{
    ...
    try {
      ...
      const yieldAmount = ethers.formatEther(
        BigInt(griefTier * 10) * BigInt(10 ** 18),
      );
