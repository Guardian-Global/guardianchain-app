...
export async function getValidatorBids(req: Request, res: Response) {
  try {
    ...
    const mockBids = [
      {
        ...
        confidence: 95,
        specialization: ["Scientific Data", "Environmental", "Research Validation"]
      },
      {
        id: "bid_002",
        validator: {
        ...
        confidence: 92,
        specialization: ["Historical Documents", "Authentication", "Archival Records"]
      },
      {
        id: "bid_003",
        validator: {
        ...
        confidence: 88,
        specialization: ["Corporate Ethics", "Legal Evidence", "Whistleblower Protection"]
      },
      {
        id: "bid_004",
        validator: {
        ...
        confidence: 94,
        specialization: ["Medical Research", "Data Analysis", "Clinical Studies"]
      },
      {
        id: "bid_005",
        validator: {
        ...
        confidence: 87,
        specialization: ["Education Policy", "Community Impact", "Social Research"]
      }
    ];
    ...
    if (sortBy === "bidAmount") {
      ...
      filteredBids.sort((a, b) => b.validator.reputation - a.validator.reputation);
    }

    const bidsData = {
      activeBids: filteredBids,
      totalBids: mockBids.length,
      averageBidAmount: Math.round(mockBids.reduce((sum, bid) => sum + bid.bidAmount, 0) / mockBids.length),
      topValidators: [
        {
          id: "val_001",
          name: "TruthSeeker_Alpha",
