...
import {
  notifyAdminOnCritical,
  notifyAdminUserAction,
} from "../notifications/notifyAdmin";
  ...
  app.post("/api/test-notifications/memory-save", async (req, res) => {
    try {
      ...
      await notifyMemorySaved({
        ...
        reply:
          "Based on current market trends and economic indicators, I recommend a diversified portfolio focusing on renewable energy, AI technology, and defensive stocks. Consider dollar-cost averaging and maintaining 3-6 months emergency fund.",
