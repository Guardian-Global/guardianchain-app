 ...
 */
router.patch('/update-stake', authenticateToken, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/upgrade-tier', authenticateToken, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/check-feature-access', authenticateToken, async (req: Request, res: Response) => {
  try {
