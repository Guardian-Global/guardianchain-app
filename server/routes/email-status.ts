      ...
      steps: [
        {
          ...
          description:
            "Ensure you have a ProtonMail account (commander.guardian@protonmail.com recommended)",
        },
        {
          step: 2,
          title: "Generate App Password",
          description:
            "Go to ProtonMail Settings > Security > Generate app-specific password for SMTP",
        },
        {
          step: 3,
