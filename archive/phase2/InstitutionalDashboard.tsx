                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div
                              className={`w-2 h-2 rounded-full ${getStatusBadge(client.status)}`}
                            />
                            <span
                              className={`text-xs ${getStatusColor(client.status)} capitalize`}
                            >
                              {client.status}
                            </span>
                          </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      ...
                      <div>
                        <div className="text-blue-400 font-medium">
                          {Math.floor(
                            (Date.now() - client.joinDate.getTime()) /
                              (1000 * 60 * 60 * 24),
                          )}
                          d
                        </div>
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-400">
                            Allocation:{" "}
                            {(
                              (client.gttAllocation / client.aum) *
                              100
                            ).toFixed(2)}
                            % of AUM
                          </span>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-purple-500/10 rounded-lg border border-purple-500/20">
                  ...
                  <p className="text-sm text-slate-300 mb-3">
                    Fast-track institutional onboarding with dedicated
                    relationship managers, custom allocation strategies, and
                    white-glove service.
                  </p>
