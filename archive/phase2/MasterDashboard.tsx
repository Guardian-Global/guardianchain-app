                ...
                <Card key={index} className="bg-brand-secondary border-brand-surface">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-brand-text-muted">{card.title}</p>
            ...
            <CardContent>
              <div className="space-y-3">
                {userStats.achievements.slice(0, 4).map((achievement, index) => (
                  <div key={index} className="flex items-center gap-3 p-2 bg-brand-surface rounded-lg">
            ...
            <CardContent>
              <div className="h-64 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-brand-text-muted">Chart visualization coming soon</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-brand-secondary border-brand-surface">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-brand-text-muted">Verification Rate</p>
          ...
          <Card className="bg-brand-secondary border-brand-surface">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-brand-text-muted">Growth Rate</p>
    ...
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-brand-text-muted">Active Connections</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="bg-brand-secondary border-brand-surface">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-2 bg-brand-surface rounded">
                <span className="text-sm">New Capsule Created</span>
                <span className="text-xs text-brand-text-muted">2 min ago</span>
              </div>
              <div className="flex items-center justify-between p-2 bg-brand-surface rounded">
                <span className="text-sm">User Verification</span>
                <span className="text-xs text-brand-text-muted">5 min ago</span>
              </div>
              <div className="flex items-center justify-between p-2 bg-brand-surface rounded">
                <span className="text-sm">GTT Transaction</span>
                <span className="text-xs text-brand-text-muted">8 min ago</span>
              </div>
            </div>
          </CardContent>
        </Card>
