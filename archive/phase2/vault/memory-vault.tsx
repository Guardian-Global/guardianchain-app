...
import {
  calculateMemoryVaultGrowth,
  calculateStakingReward,
  STAKING_POOLS,
  calculateInstitutionalMarketSize,
  INSTITUTIONAL_MARKETS,
  calculateVendorCosts,
  calculateOptimalPricing,
  VENDOR_COSTS,
} from "@/utils/memoryVaultCalculations";
import {
  Vault,
  Clock,
  Shield,
...
export default function MemoryVault() {
  ...
  const dataTypes = [
    ...
    // Institutional & Professional Markets
    {
      ...
      icon: Shield,
      description:
        "Court cases, depositions, legal evidence, witness testimonies",
      cost: "$500-2000",
    ...
    },
    {
      ...
      icon: Award,
      description:
        "Sports events, championships, records, athlete performances, yearbooks",
      cost: "$200-800",
    ...
    },
    {
      ...
      icon: Users,
      description:
        "Graduations, academic achievements, yearbooks, school history",
      cost: "$150-600",
    ...
    },
    {
      ...
      icon: Lock,
      description:
        "Protected disclosures, truth verification, anonymous evidence",
      cost: "$300-1500",
  ...
  const calculatePotentialValue = (initialCost: number, years: number) => {
    const annualRate =
      stakingRewards[years as keyof typeof stakingRewards]?.annual || "5%";
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-slate-800/50 border border-slate-700">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="text-white text-sm font-medium">
                  Memory Vault Capsule Creation Process
                </div>
                <div className="text-slate-300 text-xs">
                  Watch your memories transform into eternal digital assets
                </div>
              </div>
            </div>
          </div>
          ...
          <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-8">
            Transform ANY digital data into eternal digital assets. Turn family
            photos, songs, poems, messages, and life moments into investments
            that appreciate for centuries.
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-slate-300 mb-4">
                  Spend $200 photographer + $50/year storage = $5,200 over 100
                  years
                </p>
          ...
          <CardContent className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-300 text-lg">
                Preventing AI & Power Alteration of Reality Through Validated
                Digital Memory Preservation
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card
                className="bg-slate-800/50 border-slate-600 hover:border-red-500/50 transition-all cursor-pointer"
              ...
              >
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-slate-300 text-sm">
                    Legal verification for binding truth capsules
                  </p>
                  <Button className="mt-2 bg-red-600 hover:bg-red-700 text-white text-xs px-3 py-1">
                    ACCESS NOW
                  </Button>
                </CardContent>
              </Card>
              <Card
                className="bg-slate-800/50 border-slate-600 hover:border-yellow-500/50 transition-all cursor-pointer"
              ...
              >
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-slate-300 text-sm">
                    GTT rewards for community investigation
                  </p>
                  <Button className="mt-2 bg-yellow-600 hover:bg-yellow-700 text-white text-xs px-3 py-1">
                    START BOUNTY
                  </Button>
                </CardContent>
              </Card>
              <Card
                className="bg-slate-800/50 border-slate-600 hover:border-green-500/50 transition-all cursor-pointer"
              ...
              >
                <CardContent className="p-4 text-center">
                  ...
                  <Button className="mt-2 bg-green-600 hover:bg-green-700 text-white text-xs px-3 py-1">
                    REDEEM TRUTH
                  </Button>
                </CardContent>
              </Card>
              <Card
                className="bg-slate-800/50 border-slate-600 hover:border-purple-500/50 transition-all cursor-pointer"
              ...
              >
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-slate-300 text-sm">
                    Secure whistleblower disclosure portal
                  </p>
                  <Button className="mt-2 bg-purple-600 hover:bg-purple-700 text-white text-xs px-3 py-1">
                    DISCLOSE SAFELY
                  </Button>
                </CardContent>
              </Card>
            ...
            <div className="text-center mt-6">
              <p className="text-red-400 font-semibold">
                Humans must validate and preserve actual reality before AI
                alters truth forever
              </p>
              <div className="mt-4">
                <Button
                  className="bg-red-600 hover:bg-red-700 text-white mx-2"
                  onClick={() =>
                    (window.location.href = "/whistleblower-sanctuary")
                  }
                >
        ...
        <div className="mb-12">
          ...
          <div className="text-center mb-8">
            <p className="text-slate-300 text-lg">
              Personal & Family + Institutional Markets (Courts, Schools,
              Sports, Legal)
            </p>
          </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    ...
                    <Progress
                      value={Math.min((stakingYears / 100) * 100, 100)}
                      className="h-2"
                    />
              ...
              <div>
                ...
                <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-600">
                  <p className="text-slate-300 italic">
                    "Happy 16th birthday, my dear great-granddaughter! I'm
                    writing this in 2025, hoping you'll read it in 2125. I
                    invested $15 in this message capsule. I wonder what it's
                    worth now? Remember: family love is the only currency that
                    appreciates forever. ❤️"
                  </p>
          ...
          <CardContent>
            ...
            <div className="text-center mt-8">
              <p className="text-slate-300 text-lg mb-4">
                Courts, Schools, Sports Events, Legal Firms - Preventing
                institutional memory loss forever
              </p>
              <p className="text-blue-400 font-semibold">
                Global junior athletics, yearbooks, discoveries, awards - no
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h3 className="text-white text-lg font-bold mb-4">
                  Real Vendor Costs Per Capsule
                </h3>
                <div className="space-y-3">
                  <div className="flex justify-between p-3 bg-slate-800/50 rounded-lg">
                    <span className="text-slate-300">
                      IPFS Storage (per GB/year)
                    </span>
                    <span className="text-red-400">
                      ${VENDOR_COSTS.ipfsStorage}
                    </span>
                  </div>
                  <div className="flex justify-between p-3 bg-slate-800/50 rounded-lg">
                    <span className="text-slate-300">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-green-400">
                          ...
                          {
                            calculateOptimalPricing(
                              calculateVendorCosts(1, 5, false, false),
                              false,
                              false,
                            ).finalPrice
                          }
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg">
                    <h4 className="text-blue-400 font-semibold mb-2">
                      Institutional Legal (10GB)
                    </h4>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-slate-300">Vendor Costs:</span>
                        <span className="text-red-400">
                          ${calculateVendorCosts(10, 20, true, true).toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-300">Our Price:</span>
                        <span className="text-green-400">
                          ...
                          {
                            calculateOptimalPricing(
                              calculateVendorCosts(10, 20, true, true),
                              true,
                              false,
                            ).finalPrice
                          }
                  ...
                  <div className="p-4 bg-gradient-to-r from-green-600/20 to-emerald-600/20 rounded-lg border border-green-500/30">
                    ...
                    <p className="text-slate-300 text-center text-sm mt-2">
                      Sustainable scaling with institutional 2.5x multiplier
                      funding personal markets
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="text-center space-y-6">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            >
              ...
              {selectedDataType
                ? dataTypes.find((t) => t.id === selectedDataType)?.cost
                : "Select Data Type"}
              )
            </Button>
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Join thousands of families who have transformed their photo expenses
            into generational wealth. Your memories become your family's
            financial legacy.
          </p>
        </div>
      </div>
