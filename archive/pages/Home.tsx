              ...
              <Card className="bg-slate-800/50 border-slate-700">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="text-sm text-gray-400">
                    Complete 5 more verifications to unlock SEEKER tier with
                    enhanced rewards.
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent className="space-y-4">
                <Button className="w-full" asChild>
                  <Link href="/create-capsule">Create New Capsule</Link>
                </Button>
          ...
          <TabsContent value="verify">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                ...
                <CardDescription>
                  Help verify truth and earn GTT rewards
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8 text-gray-400">
                  ...
                  <p className="text-sm">
                    Check back later for new verification opportunities.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="earn">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                ...
                <CardDescription>
                  Multiple ways to earn GTT tokens
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 bg-slate-700/30 rounded-lg">
                    ...
                    <p className="text-sm text-gray-400 mb-3">
                      Earn 10-100 GTT per verified capsule
                    </p>
