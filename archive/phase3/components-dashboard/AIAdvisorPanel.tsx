  ...
  const [insights] = useState<AIInsight[]>([
    {
      ...
      description:
        'Based on your recent capsules, adding "blockchain-verified" and "AI-enhanced" tags could increase visibility by 34%.',
      confidence: 87,
      actionable: true,
    },
    {
      ...
      description:
        "Current market conditions suggest optimal GTT staking window in the next 72 hours for maximum yield.",
      confidence: 92,
      actionable: true,
    },
    {
      ...
      description:
        "Your capsules with emotional resonance scores above 8.5 receive 40% more community verification.",
      confidence: 95,
      actionable: false,
    },
    {
      ...
      description:
        "Consider upgrading to Creator tier for access to professional Veritas seals and higher yield rates.",
      confidence: 78,
      actionable: true,
    },
  ]);
      ...
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription>
              Powered by GPT-4 • Personalized insights
            </CardDescription>
          </div>
        </div>
      </CardHeader>
