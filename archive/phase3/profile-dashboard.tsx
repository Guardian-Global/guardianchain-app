      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">
            Manage your GuardianChain account and preferences
          </p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                <Badge
                  className={
                    tierColors[user.tier] || "bg-slate-600/20 text-slate-400"
                  }
                >
                  {user.tier}
                </Badge>
                <span className="text-slate-400 text-sm">
                  ...
                  {user.tier === "CREATOR" &&
                    "Full platform access with creation tools"}
                  {user.tier === "SOVEREIGN" &&
                    "Ultimate access with governance rights"}
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-purple-200 text-sm">
                    Unlock quantum features, AI personas, and advanced security
                  </p>
                </div>
              </div>
              <Button
          ...
          >
            <CardContent className="p-6 text-center">
              ...
              <p className="text-slate-400 text-sm">
                Start preserving your truth
              </p>
            </CardContent>
          </Card>

          <Card
            className="bg-slate-800 border-slate-700 hover:border-green-500/50 transition-colors cursor-pointer"
