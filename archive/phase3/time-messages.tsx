...
export default function TimeMessages() {
  ...
  const realisticExamples = [
    {
      message:
        "Happy Sweet 16, my darling granddaughter! I'm writing this when you're just 1 year old. I invested $15 in this message. Remember: the real value is in our family's love and memories. ❤️",
      deliveryYear: 2040,
      currentValue: "$15",
      estimatedValue: "$24",
    ...
    {
      message:
        "Congratulations on your college graduation! I'm your great-grandfather, writing this in 2025. This $25 message capsule is a small token of our pride in you. Work hard, dream big, and remember that education is the most valuable investment. Your family is proud of you!",
      deliveryYear: 2047,
      currentValue: "$25",
      estimatedValue: "$50",
    ...
    {
      message:
        "My dearest future daughter-in-law, welcome to our family! I'm writing this before my son even knows you exist. This $50 message is a small contribution to your wedding day. May your love grow steadily and beautifully over time. With all my love, Mom",
      deliveryYear: 2055,
      currentValue: "$50",
      estimatedValue: "$135",
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-bold text-white mb-6">
            Time-Lock Messages
            <Badge className="ml-4 bg-indigo-600/20 text-indigo-400">
              VIRAL POTENTIAL
            </Badge>
          </h1>
          <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-8">
            Send messages years into the future that grow in value while they
            wait. Turn a $15 birthday wish into a $50,000 gift that arrives
            exactly when needed.
          </p>
        </div>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent className="space-y-6">
                ...
                {deliveryDate && (
                  <div className="p-4 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-lg border border-indigo-500/30">
                    ...
                    <p className="text-center text-xs text-red-400 mt-2">
                      *Projections are estimates only. Not financial advice or
                      guarantees.
                    </p>
                  </div>
                )}
                ...
                >
                  ...
                  Lock Message for {getYearsUntilDelivery()} Years ($
                  {investment})
                </Button>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="text-center mb-4">
                  <h3 className="text-white font-semibold text-lg mb-2">
                    Time-Lock Message Creation
                  </h3>
                  <p className="text-slate-300 text-sm">
                    See how messages are sealed for future delivery
                  </p>
                </div>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
                  ...
                  <p className="text-red-300 text-xs leading-relaxed">
                    *Value projections are hypothetical estimates based on
                    conservative historical market averages. These are NOT
                    financial advice, investment recommendations, or guarantees
                    of future performance. Actual values may be higher or lower,
                    including potential total loss. Platform is for
                    entertainment and educational purposes. Consult financial
          ...
          <Card className="bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border-indigo-500/30">
            <CardContent className="p-8">
              ...
              <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
                ...
                discovering they're worth more than most investments. The love
                grows, and so does the value.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-400 text-sm">
                    Guaranteed delivery decades later
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-slate-400 text-sm">
                    Love that appreciates over time
                  </p>
                </div>
              </div>
