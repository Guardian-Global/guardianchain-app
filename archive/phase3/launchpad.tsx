  ...
  const featuredProjects = [
    {
      ...
      description:
        "A decentralized system for verifying climate research data and environmental claims.",
    ...
    },
    {
      ...
      description:
        "Building a blockchain-based archive of peer-reviewed medical research.",
      category: "Health",
      votes: 189,
      timeLeft: "5 days",
      reward: 2000,
    ...
    },
    {
      ...
      description:
        "Immutable verification system for legal evidence and court documents.",
      category: "Legal",
      votes: 134,
      timeLeft: "2 days",
      reward: 2000,
  ...
  const upcomingProjects = [
    {
      ...
      description:
        "AI-powered system for real-time news verification and fact-checking.",
      category: "Technology",
    ...
    },
    {
      ...
      description:
        "End-to-end supply chain verification for consumer transparency.",
      category: "Business",
            ...
            <CardTitle className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm font-normal">
                  Discover and support the next generation of truth verification
                  projects
                </p>
              </div>
            </CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {featuredProjects.map((project) => (
                <Card
                  key={project.id}
                  className="bg-slate-700/30 border-slate-600 hover:border-slate-500 transition-colors"
                >
                  <CardContent className="p-6">
