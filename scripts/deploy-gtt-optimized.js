...
async function main() {
  ...
  console.log(
    "🔗 Contract URL: https://polygonscan.com/address/" + gttToken.address,
  );
  ...
  console.log(
    "3. 📈 Submit to CoinMarketCap: https://coinmarketcap.com/request-crypto",
  );
  console.log(
    "4. 🔍 Verify on Polygonscan: npx hardhat verify",
    gttToken.address,
    "--network polygon",
  );
