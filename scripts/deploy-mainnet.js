...
async function main() {
  ...
  if (parseFloat(balanceInMatic) < 0.1) {
    console.log("⚠️  WARNING: Low MATIC balance. Need at least 0.1 MATIC for deployment.");
  }
  ...
  if (network.chainId !== 137n) {
    throw new Error("❌ Not connected to Polygon Mainnet! Expected Chain ID: 137");
  }
  ...
  console.log("Initial Supply:", hre.ethers.formatUnits(initialSupply, 18), "GTT");
  ...
  console.log("TruthVault GTT Balance:", hre.ethers.formatUnits(vaultBalance, 18));
  ...
  console.log(`CapsuleFactory: https://polygonscan.com/address/${factoryAddress}`);
}
