...
async function main() {
  ...
  console.log("QuickSwap URL:", `https://quickswap.exchange/#/add/${GTT_TOKEN_ADDRESS}/ETH`);
  ...
  const initialPrice = Number(ethers.formatEther(maticAmount)) / Number(ethers.formatEther(gttAmount));
  console.log("\n💲 Initial GTT Price:");
