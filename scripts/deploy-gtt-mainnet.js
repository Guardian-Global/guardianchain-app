...
async function main() {
  ...
  if (balance < ethers.parseEther("1.0")) {
    console.log(
      "⚠️  Warning: Low MATIC balance. Recommended: 5+ MATIC for deployment and initial operations",
    );
  }
  ...
  console.log(
    `   npx hardhat verify --network polygon ${contractAddress} ${treasuryWallet}`,
  );
