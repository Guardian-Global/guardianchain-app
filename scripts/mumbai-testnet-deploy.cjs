...
async function main() {
  ...
  try {
    ...
    console.log("🔗 Mumbai Explorer:", `https://mumbai.polygonscan.com/address/${deployedAddress}`);
    ...
    fs.writeFileSync('mumbai-gtt-deployment.json', JSON.stringify(deploymentInfo, null, 2));
