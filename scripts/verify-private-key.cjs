...
async function main() {
  ...
  const privateKeyFromScreenshot = "8b170cf9fdb9a9dc5b1e6229ab0e8ac2fde5198e422f8d72f6861b59edf8c7b8";
  ...
  console.log("To deploy GTT token to: 0x742d35Cc66535C0532925a3b8d0E9B01d9c5d9A6C");
}
