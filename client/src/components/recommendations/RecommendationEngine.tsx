  ...
  const generateRecommendations = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "AI has analyzed your preferences and found new relevant capsules",
      });
    } catch (error: any) {
      toast({
  ...
  const analyzeProfile = async () => {
    try {
      ...
      toast({
        ...
        description:
          "Your interest profile has been refreshed based on recent activity",
      });
    } catch (error: any) {
      toast({
          ...
          <CardTitle className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm font-normal">
                Personalized capsule discovery powered by AI
              </p>
            </div>
          </CardTitle>
        </CardHeader>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-slate-400 mb-4">
                    Click "Get Recommendations" to let AI analyze and suggest
                    relevant capsules for you.
                  </p>
                  <Button
                    onClick={generateRecommendations}
          ...
          {userProfile ? (
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-slate-400 mb-4">
                  Let AI analyze your activity to build a personalized interest
                  profile.
                </p>
                <Button
                  onClick={analyzeProfile}
