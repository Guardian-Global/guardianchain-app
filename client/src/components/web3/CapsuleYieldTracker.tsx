...
export default function CapsuleYieldTracker({
  capsuleId,
  embedded = false,
}: CapsuleYieldTrackerProps) {
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Badge
                    ...
                    className={
                      capsuleData?.[4] ? "bg-green-600" : "bg-yellow-600"
                    }
                  >
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-slate-700/30 rounded-lg p-4">
                ...
                <div className="text-xs text-slate-500 mt-1">
                  ≈ $
                  {(parseFloat(formatYield(yieldInfo?.[0])) * 0.85).toFixed(2)}{" "}
                  USD
                </div>
              </div>
              ...
              <div className="bg-slate-700/30 rounded-lg p-4">
                ...
                <div className="w-full bg-slate-600 rounded-full h-2 mt-2">
                  <div
                    ...
                    style={{
                      width: `${yieldInfo?.[1] ? Number(yieldInfo[1]) : 0}%`,
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="bg-slate-700/20 rounded-lg p-4">
              ...
              <div className="text-xs text-slate-400 mt-2">
                7-day yield progression showing emotional impact and truth
                verification
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="text-white ml-2">
                    {capsuleData?.[0]
                      ? `${(capsuleData[0] as string).slice(0, 6)}...${(
                          capsuleData[0] as string
                        ).slice(-4)}`
                      : "Unknown"}
                  </span>
                </div>
            ...
            {!embedded && (
              <div className="flex gap-2 pt-4">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    window.open(`/capsule/${currentCapsuleId}`, "_blank")
                  }
                  className="border-slate-600 text-slate-300 hover:bg-slate-700"
                >
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    copyToClipboard(generateShareUrl(), "Share URL")
                  }
                  className="border-slate-600 text-slate-300 hover:bg-slate-700"
                >
