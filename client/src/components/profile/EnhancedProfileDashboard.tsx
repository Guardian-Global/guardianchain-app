              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      {profileData.stats?.verificationScore || 0} Score
                    </span>
                  </div>
                </div>
              </div>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950 dark:to-orange-950 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Joined GuardianChain during launch phase
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Account verified for authenticity
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 p-4 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Created your first truth capsule
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950 dark:to-orange-950 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
                    <div className="text-center">
                      ...
                      <h3 className="font-semibold text-lg">
                        {profileData.stats?.gttBalance || 0}
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        GTT Balance
                      </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        id="ai-assistant"
                        defaultChecked={
                          profileData.preferences?.aiAssistantEnabled
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        id="public-profile"
                        defaultChecked={profileData.preferences?.publicProfile}
                      />
                    </div>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={
                      profileData.preferences?.emailNotifications || false
                    }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={
                      profileData.preferences?.aiAssistantEnabled || false
                    }
                    onCheckedChange={(checked) =>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-muted rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your account is secured with enterprise-grade
                    authentication.
                  </p>
                </div>
              ...
              <CardContent className="space-y-6">
                <div className="text-center p-6 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950 dark:to-blue-950 rounded-lg">
                  ...
                  <p className="text-muted-foreground">
                    Set up founder profiles for you, your wife, and your son
                    with special privileges and recognition.
                  </p>
                </div>
