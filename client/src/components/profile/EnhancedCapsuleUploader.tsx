    ...
    try {
      ...
      await mintNFT.mutateAsync({
        ...
        metadata: {
          ...
          attributes: [
            {
              trait_type: "Truth Score",
              value: analysisResult.truthLikelihood * 100,
            },
            {
              trait_type: "Emotional Resonance",
              value: analysisResult.emotionalResonance * 100,
            },
          ...
          <Card className="p-4 bg-green-50 border-green-200 dark:bg-green-950 dark:border-green-800">
            <div className="text-center">
              ...
              <p className="text-green-700 dark:text-green-300 mb-4">
                Your content has been uploaded, analyzed, minted as an NFT, and
                added to the blockchain.
              </p>
              <Button
                onClick={() =>
                  (window.location.href = `/capsule/${capsuleData?.id}`)
                }
