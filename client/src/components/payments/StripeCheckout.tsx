  ...
  const handleUpgrade = () => {
    if (selectedTierData?.price === 0) {
      toast({
        ...
        description:
          "You're already on the free Explorer tier! Select a paid tier to upgrade.",
      });
      return;
    }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">
            Upgrade Your <span className="text-purple-400">GUARDIANCHAIN</span>{" "}
            Experience
          </h1>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Choose the perfect plan to enhance your truth verification
            capabilities and earn more GTT tokens
          </p>
        </div>
            ...
            >
              ...
              <CardHeader className="text-center pb-4">
                <div className="flex justify-center mb-4">
                  <tier.icon
                    className={`h-12 w-12 ${tier.color.split(" ")[1]}`}
                  />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-400">
              Join the largest truth verification community
            </p>
          </div>
          <div className="text-center">
