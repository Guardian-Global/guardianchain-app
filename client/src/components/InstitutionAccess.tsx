          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-slate-700/50 rounded-lg p-3">
                <div className="text-lg font-bold text-white">
                  {
                    new Set(institutionalRoles.map((role) => role.institution))
                      .size
                  }
                </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center space-x-3">
                        <div
                          className={`w-10 h-10 ${getInstitutionColor(role.institutionType)} rounded-lg flex items-center justify-center`}
                        >
                      ...
                      <Badge
                        className={`${getStatusColor(role.status)} text-white`}
                      >
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <Badge
                          variant="outline"
                          className="border-slate-600 text-slate-300 mb-2"
                        >
                          {role.role}
                        </Badge>
                    ...
                    <div className="flex justify-between items-center mt-4 pt-3 border-t border-slate-700">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          className="border-slate-600 text-slate-300 h-7 px-3"
                        >
                          View Details
                        </Button>
                      </div>
            ...
            <div className="border-t border-slate-700 pt-4">
              <div className="flex justify-between items-center">
                <div className="text-xs text-slate-400">
                  Institutional access enables enhanced verification and
                  compliance features
                </div>
                <Button
                  size="sm"
