...
import { Shield, CheckCircle, XCircle, Search, AlertTriangle, Zap } from 'lucide-react';
              ...
              <Card className="border-green-500/30 bg-green-900/20">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-green-400">✅ Verified Capsule</h3>
                      <p className="text-sm text-slate-300">This capsule is authentic and verified</p>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-white font-semibold">{verificationResult.capsuleData.title}</p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-slate-400">Creator</label>
                          <p className="text-white font-mono text-sm">{verificationResult.capsuleData.creator}</p>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-slate-400">Category</label>
                          <Badge className={`${getCategoryColor(verificationResult.capsuleData.category)} text-white`}>
                      ...
                      <div className="space-y-3">
                        <div>
                          <label className="text-sm font-medium text-slate-400">Grief Score</label>
                          <div className="flex items-center gap-2">
                            <span className="text-2xl font-bold text-yellow-400">{verificationResult.capsuleData.griefScore}</span>
                            <Zap className="w-4 h-4 text-yellow-400" />
                          </div>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-slate-400">Seal Status</label>
                          <Badge className="bg-green-600 text-white">
                            {verificationResult.capsuleData.sealStatus}
                          </Badge>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-slate-400">DocuSign ID</label>
                          <p className="text-blue-400 font-mono text-sm">{verificationResult.capsuleData.docuSignId}</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-300">
                        Capsule not found or invalid. Please check the ID and try again.
                      </p>
                    </div>
                  </div>
                </CardContent>
