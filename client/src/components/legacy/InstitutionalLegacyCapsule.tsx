...
interface InstitutionalLegacy {
  ...
  institutionType: 'corporation' | 'government' | 'foundation' | 'university' | 'ngo';
...
export function InstitutionalLegacyCapsule() {
  const [activeTab, setActiveTab] = useState<'create' | 'portfolio' | 'templates' | 'governance'>('create');
  const [selectedTemplate, setSelectedTemplate] = useState<string>('');

  const [legacyTemplates] = useState<LegacyTemplate[]>([
    {
      name: 'CEO Legacy Vault',
      description: 'Comprehensive leadership documentation for Fortune 500 CEOs and C-suite executives',
      minStaking: 50000000, // $50M
      targetAudience: 'Fortune 500 Companies, Executive Boards',
      features: ['Strategic Decision Archive', 'Leadership Philosophy', 'Crisis Management Records', 'Succession Planning'],
      roi: '847% over 100 years',
      category: 'leadership'
    },
    {
      name: 'Innovation Patent Archive',
      description: 'Institutional R&D documentation and patent legacy for technology companies',
      minStaking: 25000000, // $25M
      targetAudience: 'Tech Companies, Research Institutions',
      features: ['Patent Documentation', 'R&D Process Records', 'Innovation Timeline', 'Technical Knowledge Transfer'],
      roi: '1,240% over 50 years',
      category: 'innovation'
    },
    {
      name: 'Government Policy Legacy',
      description: 'Official government decision-making records and policy development documentation',
      minStaking: 100000000, // $100M
      targetAudience: 'Government Agencies, Sovereign Nations',
      features: ['Policy Development Records', 'Decision Rationale Archive', 'Public Impact Analysis', 'Historical Context'],
      roi: '567% over 100 years',
      category: 'milestone'
    },
    {
      name: 'Crisis Response Archive',
      description: 'Institutional crisis management and response documentation for future preparedness',
      minStaking: 75000000, // $75M
      targetAudience: 'Emergency Response Organizations, Corporations',
      features: ['Crisis Timeline Documentation', 'Response Strategy Archive', 'Lessons Learned Database', 'Recovery Protocols'],
  ...
  const getInstitutionTypeColor = (type: string) => {
    switch (type) {
      case 'corporation': return 'bg-blue-600/20 text-blue-400';
      case 'government': return 'bg-purple-600/20 text-purple-400';
      case 'foundation': return 'bg-green-600/20 text-green-400';
      case 'university': return 'bg-yellow-600/20 text-yellow-400';
      case 'ngo': return 'bg-red-600/20 text-red-400';
  ...
  const getCapsuleTypeColor = (type: string) => {
    switch (type) {
      case 'leadership': return 'bg-purple-600/20 text-purple-400';
      case 'innovation': return 'bg-blue-600/20 text-blue-400';
      case 'impact': return 'bg-green-600/20 text-green-400';
      case 'crisis': return 'bg-red-600/20 text-red-400';
      case 'milestone': return 'bg-yellow-600/20 text-yellow-400';
      default: return 'bg-gray-600/20 text-gray-400';
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">Institutional Legacy Capsules</h2>
          <p className="text-slate-400">
            Preserve institutional knowledge and leadership legacy with multi-generational value appreciation
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatCurrency(activeLegacies.reduce((sum, legacy) => sum + legacy.stakingAmount, 0))}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatCurrency(activeLegacies.reduce((sum, legacy) => sum + legacy.projectedValue, 0))}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">{activeLegacies.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {activeLegacies.reduce((sum, legacy) => sum + legacy.trusteeCount, 0)}
                </p>
              </div>
            </div>
          </CardContent>
      ...
      {activeTab === 'create' && (
        <div className="space-y-6">
          <h3 className="text-lg font-semibold text-white">Create Institutional Legacy Capsule</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Institution Details</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-slate-300 mb-2 block">Institution Name</label>
                  <Input 
                ...
                <div>
                  <label className="text-sm font-medium text-slate-300 mb-2 block">Institution Type</label>
                  <select 
                    value={createForm.institutionType}
                    onChange={(e) => setCreateForm({...createForm, institutionType: e.target.value as any})}
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setCreateForm({...createForm, capsuleType: e.target.value as any})}
                    className="w-full p-2 bg-slate-700 border border-slate-600 rounded-md text-white"
                  >
            ...
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium text-slate-300 mb-2 block">Trustee Count</label>
                  <Input 
                    type="number"
                    value={createForm.trusteeCount}
                    onChange={(e) => setCreateForm({...createForm, trusteeCount: parseInt(e.target.value)})}
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="text-sm font-medium text-slate-300 mb-2 block">Legacy Documentation</label>
                <Textarea 
                  value={createForm.legacyContent}
                  onChange={(e) => setCreateForm({...createForm, legacyContent: e.target.value})}
              ...
              <div>
                <label className="text-sm font-medium text-slate-300 mb-2 block">Successor Instructions</label>
                <Textarea 
                  value={createForm.successorInstructions}
                  onChange={(e) => setCreateForm({...createForm, successorInstructions: e.target.value})}
      ...
      {activeTab === 'portfolio' && (
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-white">Active Institutional Legacies</h3>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <h4 className="text-xl font-bold text-white">{legacy.institutionName}</h4>
                          <div className="flex items-center gap-2 mt-1">
                            <Badge className={getInstitutionTypeColor(legacy.institutionType)}>
                              {legacy.institutionType.toUpperCase()}
                            </Badge>
                            <Badge className={getCapsuleTypeColor(legacy.capsuleType)}>
                      ...
                      <div className="grid grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold text-green-400">{formatCurrency(legacy.projectedValue)}</p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">Trustees</p>
                          <p className="text-lg font-bold text-white">{legacy.trusteeCount}</p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">Period</p>
                          <p className="text-lg font-bold text-white">{legacy.stakingPeriod}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-400">Unlock: {legacy.unlockDate}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          {legacy.publicAccess ? (
                    ...
                    <div className="text-right ml-6">
                      <Badge className={`mb-3 ${
                        ...
                        legacy.status === 'locked' ? 'bg-yellow-600/20 text-yellow-400' :
      ...
      {activeTab === 'templates' && (
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-white">Institutional Legacy Templates</h3>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <Badge className={getCapsuleTypeColor(template.category)}>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400">{template.targetAudience}</p>
                        </div>
                        <div>
      ...
      {activeTab === 'governance' && (
        <div className="space-y-6">
          <h3 className="text-lg font-semibold text-white">Legacy Governance</h3>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium">{activeLegacies.length}</span>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-400 font-medium">
                      {activeLegacies.filter(l => l.complianceLevel === 'enterprise').length}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Government Grade</span>
                    <span className="text-green-400 font-medium">
                      {activeLegacies.filter(l => l.complianceLevel === 'government').length}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Audit Status</span>
                    <span className="text-green-400 font-medium">All Compliant</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-900/50 to-green-900/50 border-purple-500/30">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-xl font-bold text-white mb-2">Institutional Legacy Excellence</h4>
                  <p className="text-purple-300 mb-4">
                    Preserving institutional knowledge with {formatCurrency(activeLegacies.reduce((sum, legacy) => sum + legacy.stakingAmount, 0))} in staked value across Fortune 500 and government institutions
                  </p>
                  <div className="flex items-center gap-4">
