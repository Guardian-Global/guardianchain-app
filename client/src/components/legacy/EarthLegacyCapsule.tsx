...
export function EarthLegacyCapsule() {
  const [activeTab, setActiveTab] = useState<
    "create" | "portfolio" | "templates" | "impact"
  >("create");
  ...
  const [legacyTemplates] = useState<LegacyTemplate[]>([
    {
      ...
      description:
        "Multi-generational rainforest protection with carbon credit generation and biodiversity preservation",
      minStaking: 100000000, // $100M
      impactMetrics: [
        "50,000 hectares protected",
        "2.5M tons CO2 annually",
        "10,000+ species",
      ],
      features: [
    ...
    },
    {
      ...
      description:
        "Global coral reef restoration and marine ecosystem preservation across critical oceanic regions",
      minStaking: 75000000, // $75M
      impactMetrics: [
        "25,000 hectares restored",
        "500+ species protected",
        "10M marine life benefited",
      ],
      features: [
        "Marine Sanctuary Creation",
        "Coral Breeding Programs",
    ...
    },
    {
      ...
      description:
        "Multi-generational renewable energy installations with perpetual clean energy generation",
      minStaking: 200000000, // $200M
      impactMetrics: [
        "1,000 MW capacity",
        "5M tons CO2 avoided annually",
        "2M households powered",
      ],
      features: [
        "Solar/Wind Farm Networks",
    ...
    },
    {
      ...
      description:
        "Comprehensive climate change mitigation through carbon sequestration and atmospheric restoration",
      minStaking: 500000000, // $500M
      impactMetrics: [
        "100M tons CO2 sequestered",
    ...
    },
    {
      ...
      description:
        "Comprehensive species preservation program with genetic banking and habitat restoration",
      minStaking: 150000000, // $150M
      impactMetrics: [
        "1,000+ species protected",
        "500,000 hectares habitat",
  ...
  const totalCarbonOffset = activeEarthLegacies.reduce(
    (sum, legacy) => sum + legacy.carbonOffset,
    0,
  );
  const totalSpeciesProtected = activeEarthLegacies.reduce(
    (sum, legacy) => sum + legacy.speciesProtected,
    0,
  );
  const totalAreaProtected = activeEarthLegacies.reduce(
    (sum, legacy) => sum + legacy.areaProtected,
    0,
  );
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">
            Earth Legacy Capsules
          </h2>
          <p className="text-slate-400">
            Preserve Earth's natural heritage with multi-generational
            environmental stewardship and value appreciation
          </p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatNumber(totalSpeciesProtected)}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatNumber(totalAreaProtected)} ha
                </p>
              </div>
            </div>
          </CardContent>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setCreateForm({
                      ...createForm,
                      projectedImpact: e.target.value,
                    })
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setCreateForm({
                      ...createForm,
                      sustainabilityPlan: e.target.value,
                    })
                  }
                      ...
                      <div className="grid grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold text-green-400">
                            {formatNumber(legacy.carbonOffset)}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">
                          ...
                          <p className="text-lg font-bold text-white">
                            {formatNumber(legacy.speciesProtected)}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">
                          ...
                          <p className="text-lg font-bold text-white">
                            {formatNumber(legacy.areaProtected)} ha
                          </p>
                        </div>
                      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-400 font-bold">
                      {formatNumber(totalAreaProtected)} hectares
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Ecosystem Value</span>
                    <span className="text-white font-medium">
                      {formatCurrency(totalAreaProtected * 25000)}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-green-300 mb-4">
                    Protecting {formatNumber(totalAreaProtected)} hectares with{" "}
                    {formatNumber(totalCarbonOffset)} tons annual CO2 offset
                    across {activeEarthLegacies.length} legacy projects
                  </p>
                  <div className="flex items-center gap-4">
                    <ArrowUpRight className="h-5 w-5 text-green-400" />
                    <span className="text-sm text-green-300">
                      987% average environmental value appreciation over
                      100-year periods
                    </span>
                  </div>
                </div>
