...
export default function FigmaIntegrationGuide() {
  ...
  const figmaTokens = {
    colors: [
      {
        name: "Primary (Guardian Blue)",
        value: "#3b82f6",
        description: "Primary brand color",
      },
      {
        name: "Secondary (Vault Black)",
        value: "#0f172a",
        description: "Dark background color",
      },
      {
        name: "Accent (Veritas Green)",
        value: "#22c55e",
        description: "Success and verification color",
      },
      {
        name: "Surface (Slate)",
        value: "#1e293b",
      ...
      },
      {
        name: "Warning",
        value: "#f97316",
        description: "Warning and signal color",
      },
      {
        name: "Text Light",
        value: "#f1f5f9",
    ...
    typography: [
      {
        name: "Brand Font",
        value: "Space Grotesk",
        description: "Headlines and brand elements",
      },
      {
        name: "Sans Font",
        value: "Inter",
    ...
    spacing: [
      ...
      },
      {
        name: "Vault Radius",
        value: "24px",
        description: "Medium component radius",
      },
      {
        name: "Button Radius",
        value: "8px",
    ...
    shadows: [
      ...
      {
        name: "Install Button Shadow",
        value: "0 2px 6px rgba(0,0,0,0.25)",
        description: "Install button shadow",
      },
    ],
  };
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        <Button
          ...
          onClick={() =>
            copyToClipboard(JSON.stringify(figmaTokens, null, 2), "all-tokens")
          }
        >
        ...
        <Button
          ...
          onClick={() =>
            window.open("/figma-style-guide.guardianchain.json", "_blank")
          }
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {figmaTokens.shadows.map((token) => (
              <div key={token.name} className="space-y-3">
                ...
                >
                  <span className="text-brand-light font-brand">
                    {token.name}
                  </span>
                </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-brand-light font-medium">
                  Import Color Tokens
                </h4>
                <p className="text-brand-light/60 text-sm">
                  Copy color values to your Figma color styles
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-brand-light/60 text-sm">
                  Configure Space Grotesk and Inter font families
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-brand-light/60 text-sm">
                  Use consistent radius and spacing values
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-brand-light/60 text-sm">
                  Build reusable components with token values
                </p>
              </div>
            </div>
          </div>
