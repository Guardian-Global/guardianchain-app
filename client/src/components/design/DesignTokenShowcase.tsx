...
export default function DesignTokenShowcase() {
  const colorTokens = [
    {
      ...
      value: "#3b82f6",
      css: "brand-primary",
      description: "Guardian Blue — trust + tech",
    },
    {
      name: "Secondary",
      value: "#0f172a",
      css: "brand-secondary",
      description: "Vault Black — memory permanence",
    },
    {
      name: "Accent",
      value: "#22c55e",
      css: "brand-accent",
      description: "Veritas Green — proof and yield",
    },
    {
      name: "Surface",
      value: "#1e293b",
      css: "brand-surface",
      description: "Surface token",
    },
    {
      name: "Warning",
      value: "#f97316",
  ...
  const radiusTokens = [
    {
      ...
      value: "2rem (32px)",
      css: "rounded-capsule",
      description: "Capsule radius token",
    },
    {
      name: "Vault",
      value: "1.5rem (24px)",
      css: "rounded-vault",
      description: "Vault radius token",
    },
    {
      name: "Button",
      value: "0.5rem (8px)",
  ...
  const shadowTokens = [
    { name: "Card", css: "shadow-card", description: "Standard card shadow" },
    {
      name: "Brand",
      css: "shadow-brand",
      description: "Brand shadow with primary color",
    },
    {
      name: "Brand Large",
      css: "shadow-brand-lg",
      ...
      <Card className="bg-brand-secondary border-brand-surface">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <h3 className="text-xl font-brand text-brand-light">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-sans text-brand-light">
              Inter (Sans Font)
            </h3>
            <p className="text-brand-light/80">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="surface-card">
                <h4 className="font-brand text-brand-light mb-2">
                  Surface Card
                </h4>
                <p className="text-brand-light/80 text-sm">
                  Figma-aligned surface card component
                </p>
              </div>
