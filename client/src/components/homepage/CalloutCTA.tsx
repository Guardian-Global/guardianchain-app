  ...
  const griefTiers: GriefTier[] = [
    {
      name: "Truth Seeker",
      multiplier: "1x",
      estimatedYield: "$25-50",
      color: "text-blue-400",
    },
    {
      name: "Memory Guardian",
      multiplier: "2x",
      estimatedYield: "$75-125",
      color: "text-green-400",
    },
    {
      name: "Veritas Holder",
      multiplier: "3x",
      estimatedYield: "$150-200",
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Transform your memories into immutable digital assets. Each
              verified capsule generates GTT yield based on your GriefScore
              tier.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {griefTiers.map((tier, index) => (
              <Card
                key={index}
                className="bg-slate-800/50 border-slate-700/50 hover:border-slate-600/50 transition-all duration-300"
              >
