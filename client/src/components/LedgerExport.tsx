  ...
  const getEstimatedSize = () => {
    const baseSize =
      exportOptions.dateRange === "all"
        ? 15
        : exportOptions.dateRange === "last_year"
          ? 8
          : exportOptions.dateRange === "last_90_days"
            ? 3
            : 1;
    ...
    <Card className="bg-slate-800 border-slate-700">
      <CardHeader>
        ...
        <p className="text-slate-400 text-sm">
          Export comprehensive blockchain ledger data for analysis, compliance,
        ...
        <div className="border-t border-slate-700 pt-4">
          <div className="flex items-start space-x-2">
            ...
            <div className="text-xs text-slate-400">
              ...
              <p>
                This export contains public blockchain data only. Personal
                information and private capsule content are never included in
                exports.
              </p>
            </div>
          </div>
