      ...
      setAchievements((prev) =>
        prev.map((achievement) => {
          if (achievement.id === update.id) {
            ...
            const isUnlocked =
              !achievement.isUnlocked && newProgress >= achievement.maxProgress;
    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-slate-300">
          Unlock achievements, earn GTT tokens, and level up your GUARDIANCHAIN
          journey
        </p>
      </div>
      ...
      <Card className="bg-slate-800/50 border-yellow-500/50">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Progress
              value={(playerStats.totalXP / playerStats.nextLevelXP) * 100}
              className="h-3"
            />
          </div>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <CardTitle
                      className={`text-lg ${achievement.isUnlocked ? "text-white" : "text-slate-400"}`}
                    >
                      {achievement.name}
                    </CardTitle>
                    <p className="text-sm text-slate-400">
