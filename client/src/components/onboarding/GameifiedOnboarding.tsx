  ...
  const onboardingSteps: OnboardingStep[] = [
    {
      ...
      description:
        "Complete your profile setup and earn your first 10 GTT tokens",
      icon: Shield,
      reward: 10,
    ...
    },
    {
      ...
      description:
        "Help verify 3 truth capsules and earn 15 GTT per verification",
      icon: CheckCircle,
      reward: 45,
    ...
    },
    {
      ...
      description:
        "Link your wallet to enable GTT token transactions and earn 20 GTT",
      icon: Coins,
      reward: 20,
    ...
    },
    {
      ...
      description:
        "Share GUARDIANCHAIN with friends and earn 50 GTT per referral",
      icon: Gift,
      reward: 100,
    ...
    },
    {
      ...
      description:
        "Upgrade to Pro and unlock premium analytics plus 100 bonus GTT",
      icon: Crown,
      reward: 100,
            ...
            <div className="flex items-center justify-center gap-6 mt-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-white">
                  {totalPoints * getPointsMultiplier()}
                </div>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`p-3 rounded-lg ${isCompleted ? "bg-green-500/20" : "bg-purple-500/20"}`}
                      >
                        <Icon
                          className={`w-6 h-6 ${isCompleted ? "text-green-400" : "text-purple-400"}`}
                        />
                      </div>
                      <div>
                ...
                <CardContent>
                  ...
                  {!isCompleted ? (
                    ...
                    <div className="flex items-center gap-2 text-green-400">
                      ...
                      <Badge
                        variant="outline"
                        className="text-green-400 border-green-400 ml-auto"
                      >
                        +{step.reward * getPointsMultiplier()} GTT
                      </Badge>
                    </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <div
                        className={`p-2 rounded ${achievement.unlocked ? "bg-yellow-500/20" : "bg-slate-700"}`}
                      >
                        <Icon
                          className={`w-5 h-5 ${achievement.unlocked ? "text-yellow-400" : "text-slate-500"}`}
                        />
                      </div>
                      <div>
                        <h3
        ...
        {completedSteps.length === onboardingSteps.length && (
          <Card className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 border-purple-500/50">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-slate-300">
                You've mastered the basics of GUARDIANCHAIN. Here's your
                completion bonus!
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center space-y-4">
              ...
              <p className="text-slate-300">
                You're now ready to explore the full power of decentralized
                truth verification!
              </p>
