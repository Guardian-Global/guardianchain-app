...
export default function InstitutionalOnboarding() {
  ...
  const organizationTypes = [
    {
      ...
      description: "Large companies and multinationals",
    },
    {
      id: "government",
    ...
    },
    {
      ...
      description: "Banks, credit unions, investment firms",
    },
    {
      id: "healthcare",
    ...
    },
    {
      ...
      description: "Universities, schools, research institutes",
    },
    {
      id: "media",
      label: "Media Organization",
      description: "News outlets, publishing companies",
    },
    {
      id: "legal",
      label: "Legal Firm",
  ...
  const useCases = [
    {
      ...
      description: "Authenticate official documents and records",
    },
    {
    ...
    },
    {
      ...
      description: "Secure anonymous reporting system",
    },
    {
      id: "evidence-preservation",
      label: "Evidence Preservation",
      description: "Legal evidence and testimony storage",
    },
    {
      id: "brand-protection",
      label: "Brand Protection",
      description: "Combat misinformation and protect reputation",
    },
    {
      id: "research-integrity",
      label: "Research Integrity",
      description: "Scientific data verification and publication",
    },
    {
      id: "supply-chain",
      label: "Supply Chain Verification",
      description: "Product authenticity and traceability",
    },
    {
      id: "internal-transparency",
      label: "Internal Transparency",
      description: "Employee communications and transparency",
    },
  ];
  ...
  const complianceRequirements = [
    ...
    },
    {
      id: "fedramp",
      label: "FedRAMP",
      description: "Federal cloud computing standards",
    },
    {
      id: "other",
      label: "Other Requirements",
      description: "Custom compliance needs",
    },
  ];
  ...
  const toggleArrayField = (
    key: "useCases" | "complianceRequirements",
    value: string,
  ) => {
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Enterprise-grade truth verification infrastructure for organizations
            requiring scalable, compliant solutions
          </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      {organizationTypes.map((type) => (
                        <Card
                          ...
                          onClick={() =>
                            updateFormData("organizationType", type.id)
                          }
                        >
                      ...
                      {useCases.map((useCase) => (
                        ...
                        >
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              toggleArrayField("useCases", useCase.id)
                            }
                            className="mt-1"
                          />
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      {volumeOptions.map((volume) => (
                        <Card
                          ...
                          onClick={() =>
                            updateFormData("estimatedVolume", volume.id)
                          }
                        >
                          <CardContent className="p-4">
                      ...
                      {complianceRequirements.map((req) => (
                        ...
                        >
                          <Checkbox
                            ...
                            onCheckedChange={() =>
                              toggleArrayField("complianceRequirements", req.id)
                            }
                            className="mt-1"
                          />
                          <div className="flex-1">
                  ...
                  <div className="space-y-4 p-6 bg-slate-700/30 rounded-lg">
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          updateFormData("dataProcessing", checked)
                        }
                        className="mt-1"
                      />
                      <Label
                        ...
                        className="text-sm text-gray-300 cursor-pointer"
                      >
                        I consent to the processing of organizational data for
                        institutional onboarding and service delivery
                      </Label>
                    </div>
                  </div>
                </div>
