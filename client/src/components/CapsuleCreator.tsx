...
import { CapsuleCreationRequest, CAPSULE_CATEGORIES } from '@shared/types/capsule';
...
export default function CapsuleCreator() {
  ...
  const handleInputChange = (field: keyof CapsuleCreationRequest, value: any) => {
    ...
    <Card className="bg-slate-800 border-slate-700 max-w-4xl mx-auto">
      <CardHeader>
        ...
        <p className="text-slate-400 text-sm">
          Preserve your truth for eternity. Share your story, evidence, or memory with the world.
        </p>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="restricted">Restricted - Tier-based access</SelectItem>
          ...
          {formData.content && formData.content.length > 50 && (
            <div className="bg-slate-700/50 rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-2xl font-bold text-white">{estimatedGriefScore()}</div>
                  <div className="text-sm text-slate-400">Grief Score</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-green-400">{estimatedYield()} GTT</div>
                  <div className="text-sm text-slate-400">Estimated Yield</div>
                </div>
              </div>
              
              <p className="text-xs text-slate-500">
                These are estimates. Final values will be determined by AI analysis and community validation.
              </p>
            </div>
          )}
          ...
          <div className="flex justify-between items-center pt-4 border-t border-slate-700">
            <div className="flex items-center text-sm text-slate-400">
              ...
              Your capsule will be cryptographically sealed and submitted for verification
            </div>
