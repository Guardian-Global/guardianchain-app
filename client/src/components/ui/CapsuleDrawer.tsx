...
const mockCapsule: CapsuleData = {
  ...
  content:
    "This capsule contains evidence of systematic financial irregularities within a major corporation. The documentation includes internal emails, financial records, and witness testimonies that reveal a coordinated effort to manipulate earnings reports...",
    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description:
            "Your truth capsule has been submitted and sealed. GTT rewards will be distributed upon verification.",
        });

        // Trigger Stripe + GTT payout
        await apiRequest("POST", "/api/trigger-stripe", {
          capsuleId: (await response.json()).id,
          amount: formData.accessCost || 2.5,
        });
  ...
  const handleReplay = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: isWeb3
            ? "Web3 Replay Successful!"
            : "Capsule Replayed Successfully!",
          ...
          <ScrollArea className="h-full">
            {createMode || mode === "create" ? (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="whistleblower_protection">
                        Whistleblower Report
                      </option>
                      <option value="historical_record">
                        Historical Record
                      </option>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          accessCost: parseFloat(e.target.value) || 0,
                        }))
                      }
                      placeholder="0"
                      min="0"
              ...
              <>
                ...
                <div className="mb-6">
                  <div
                    className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(capsule.verificationStatus)} text-white`}
                  >
                    {getStatusIcon(capsule.verificationStatus)}
                    {capsule.verificationStatus.charAt(0).toUpperCase() +
                      capsule.verificationStatus.slice(1)}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <GTTYieldButton
                      ...
                      griefTier={Math.min(
                        5,
                        Math.max(1, Math.floor(capsule.truthScore / 20)),
                      )}
