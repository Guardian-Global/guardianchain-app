...
export default function GamifiedBlockchainRewardsSystem() {
  ...
  const dailyTasks = [
    { task: "Verify 3 truth capsules", reward: "25 GTT", progress: 100, completed: true },
    { task: "Share GTT token page", reward: "10 GTT", progress: 100, completed: true },
    { task: "Join 1 DAO vote", reward: "15 GTT", progress: 0, completed: false },
    { task: "Stake 100 GTT tokens", reward: "50 GTT", progress: 75, completed: false }
  ];
  ...
  const achievements = [
    { name: "Truth Pioneer", description: "Verified 100 capsules", icon: "🔍", rarity: "Epic", unlocked: true },
    { name: "GTT Collector", description: "Earned 1000 GTT", icon: "💎", rarity: "Rare", unlocked: true },
    { name: "DAO Participant", description: "Voted 50 times", icon: "🗳️", rarity: "Common", unlocked: false },
    { name: "Staking Master", description: "Staked for 30 days", icon: "⏰", rarity: "Legendary", unlocked: false }
  ];
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="text-center space-y-2">
              ...
              <div className="text-2xl font-bold text-blue-400">{currentXP.toLocaleString()}</div>
              <div className="text-sm text-slate-400">XP Points</div>
            </div>
            
            <div className="text-center space-y-2">
              <Coins className="w-8 h-8 text-green-400 mx-auto" />
              <div className="text-2xl font-bold text-green-400">{totalGTT.toLocaleString()}</div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm text-slate-400">{currentXP}/{nextLevelXP} XP</span>
            </div>
              ...
              {dailyTasks.map((task, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge className={task.completed ? "bg-green-500/20 text-green-400" : "bg-purple-500/20 text-purple-400"}>
                      {task.reward}
                    </Badge>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center text-xs">
                      <span className="text-slate-400">{task.progress}% Complete</span>
                      {task.completed && <span className="text-green-400">✓ Claimed</span>}
                    </div>
                  </div>
                </motion.div>
              ))}
              ...
              {weeklyRewards.map((entry, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className={`font-semibold ${entry.user === "You" ? 'text-purple-400' : 'text-slate-300'}`}>
          ...
          {/* Achievements */}
          <div className="space-y-3">
            <h4 className="font-semibold text-slate-300">Achievement Gallery</h4>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className={`font-semibold ${achievement.unlocked ? 'text-yellow-400' : 'text-slate-400'}`}>
                        {achievement.name}
                      </div>
