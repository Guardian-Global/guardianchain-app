          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="p-3 bg-slate-700/50 rounded-lg text-sm">
                "🚀 Just discovered GTT token! The future of truth verification
                is here. #GUARDIANCHAIN"
              </div>
              <div className="p-3 bg-slate-700/50 rounded-lg text-sm">
                "💎 GTT token showing incredible performance! Join the
                decentralized truth economy today."
              </div>
              <div className="p-3 bg-slate-700/50 rounded-lg text-sm">
                "🔥 GUARDIANCHAIN is revolutionizing how we verify truth. Don't
                miss the GTT token opportunity!"
              </div>
            </div>
          </div>
        </div>
