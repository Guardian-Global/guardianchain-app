      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-400">
            {transactions.length} pending transactions • Total fees:{" "}
            {transactions.reduce((sum, tx) => sum + tx.fee, 0).toFixed(2)} GTT
          </p>
        </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3 flex-1">
                    <div
                      className={`w-8 h-8 rounded-lg flex items-center justify-center bg-${typeInfo.color}-600`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400 space-y-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span>
                            {((Date.now() - tx.timestamp) / 1000).toFixed(0)}s
                            ago
                          </span>
                        </div>
                      </div>
