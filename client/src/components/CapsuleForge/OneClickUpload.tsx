    ...
    try {
      ...
      for (let progress = 0; progress <= 100; progress += 10) {
        ...
        setUploadedFiles((prev) =>
          prev.map((f) =>
            f.name === file.name ? { ...f, uploadProgress: progress } : f,
          ),
        );
        ...
        >
          ...
          {isDragActive ? (
            <div className="text-purple-400">
              ...
              <p className="text-sm">
                Automatic IPFS upload and content extraction
              </p>
            </div>
          ) : (
            <div className="text-slate-300">
              ...
              <div className="flex flex-wrap justify-center gap-1 mt-3">
                {[".txt", ".md", ".pdf", ".jpg", ".png", ".mp4", ".json"].map(
                  (type) => (
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`flex items-center gap-1 ${getStatusColor(file.status)}`}
                    >
