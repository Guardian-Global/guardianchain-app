...
export function VideoDisplay({
  ...
  const FallbackVideo = () => (
    <div
      className={`${sizeClasses[size]} bg-gradient-to-r ${type === "guardianchain" ? "from-purple-600 to-green-600" : "from-green-600 to-blue-600"} rounded-lg flex items-center justify-center shadow-lg animate-pulse ${className}`}
    >
  ...
  return (
    <div className="relative">
      <video
        ...
        onLoadStart={() =>
          console.log(`🎬 Video loading: ${type} from ${videoSrc}`)
        }
