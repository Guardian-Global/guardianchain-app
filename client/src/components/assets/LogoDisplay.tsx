...
export function LogoDisplay({
  ...
  const FallbackLogo = () => (
    <div
      className={`${sizeClasses[size]} bg-gradient-to-r from-purple-600 to-green-600 rounded-lg flex items-center justify-center shadow-lg ${className}`}
    >
      ...
      {(variant === "full" || variant === "icon" || variant === "main") && (
        <div className="relative">
          <img
            ...
            onLoad={() =>
              console.log(
                `✅ Logo loaded successfully: ${type} from ${logoSrc}`,
              )
            }
          />
        </div>
