...
export function AITradingOracle() {
  const [activeTab, setActiveTab] = useState<
    "predictions" | "performance" | "subscriptions"
  >("predictions");
  ...
  const [predictions] = useState<AIPrediction[]>([
    {
      ...
      reasoning:
        "Whale accumulation pattern detected, institutional buying pressure increasing",
      riskLevel: "low",
    ...
    },
    {
      ...
      reasoning:
        "Overextended rally, smart money taking profits, momentum divergence",
      riskLevel: "medium",
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatNumber(performance.active_subscribers)}
                </p>
              </div>
            </div>
          </CardContent>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-300">
                    Unlock custom AI models and white-label API access for
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">
                    {formatNumber(performance.total_predictions)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Profitable</span>
                  <span className="text-green-400 font-medium">
                    {formatNumber(performance.profitable_predictions)}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400 font-bold">
                    ${formatNumber(performance.monthly_revenue)}
                  </span>
                </div>
                <div className="flex justify-between">
