...
export function NFTMarketplacePro() {
  const [activeTab, setActiveTab] = useState<
    "trending" | "collections" | "sales" | "analytics"
  >("trending");
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            {formatCurrency(metrics.totalVolume)} all-time volume across{" "}
            {formatNumber(metrics.totalCollections)} collections
          </p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatNumber(metrics.totalNFTs)}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatETH(metrics.averagePrice)}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-white">
                  {formatNumber(metrics.uniqueTraders)}
                </p>
              </div>
            </div>
          </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-purple-400 font-bold">
                      {formatCurrency(metrics.royaltyRevenue)}
                    </span>
                  </div>
                  <div className="border-t border-slate-600 pt-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-bold text-xl">
                        {formatCurrency(
                          metrics.platformRevenue + metrics.royaltyRevenue,
                        )}
                      </span>
                    </div>
                  </div>
                  ...
                  {categoryStats.map((category, index) => (
                    <div key={category.category} className="space-y-2">
                      ...
                      <Progress
                        value={
                          (category.volume /
                            Math.max(...categoryStats.map((c) => c.volume))) *
                          100
                        }
                        className="h-2"
                      />
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-xl font-bold text-white mb-2">
                    NFT Marketplace Excellence
                  </h4>
                  <p className="text-purple-300 mb-4">
                    Leading marketplace with{" "}
                    {formatCurrency(metrics.totalVolume)} total volume and{" "}
                    {formatNumber(metrics.uniqueTraders)} active traders
                  </p>
                  <div className="flex items-center gap-4">
