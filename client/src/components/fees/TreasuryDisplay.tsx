...
export default function TreasuryDisplay({ chainId, className = "" }: TreasuryDisplayProps) {
  ...
  return (
    <Card className={`bg-gradient-to-br from-slate-800/90 to-slate-900/90 border-green-500/30 shadow-lg shadow-green-500/10 ${className}`}>
      <CardHeader>
        <CardTitle className="flex items-center gap-3">
          ...
          <div>
            <span className="text-white text-lg font-bold">GuardianChain Treasury</span>
            <p className="text-slate-400 text-sm font-normal">Community-governed protocol funds</p>
          </div>
        </CardTitle>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="text-center p-6 bg-gradient-to-br from-blue-900/30 to-blue-800/20 rounded-xl border border-blue-500/20">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-sm text-slate-300 font-medium">Total Collected</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-700/40 rounded-lg border border-blue-500/20">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-300 font-medium">Capsule Sealing</span>
              </div>
              <div className="text-right">
                <div className="text-white font-bold">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-700/40 rounded-lg border border-purple-500/20">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-300 font-medium">DAO Proposals</span>
              </div>
              <div className="text-right">
                <div className="text-white font-bold">
                  {proposalFeesTotal ? formatEther(proposalFeesTotal) : '0'} GTT
                </div>
                <div className="text-xs text-slate-400">500 GTT per proposal</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-slate-700/40 rounded-lg border border-green-500/20">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-slate-400">25 GTT per verification</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-600 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-slate-700/20 rounded-lg">
              ...
              <div className="text-sm text-slate-300 font-medium">Community Rewards</div>
              <div className="text-xs text-slate-400 mt-1">Verification incentives</div>
            </div>
            <div className="text-center p-4 bg-slate-700/20 rounded-lg">
              <Activity className="h-8 w-8 text-blue-400 mx-auto mb-2" />
              <div className="text-sm text-slate-300 font-medium">Development</div>
              <div className="text-xs text-slate-400 mt-1">Platform improvements</div>
            </div>
            <div className="text-center p-4 bg-slate-700/20 rounded-lg">
              <TrendingUp className="h-8 w-8 text-purple-400 mx-auto mb-2" />
              <div className="text-sm text-slate-300 font-medium">Infrastructure</div>
              <div className="text-xs text-slate-400 mt-1">Scaling & operations</div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="font-mono text-xs text-white mt-1">
                {treasuryAddress ? `${treasuryAddress.slice(0, 10)}...${treasuryAddress.slice(-8)}` : 'Not configured'}
              </div>
            </div>
            <div className="text-right">
              <span className="text-slate-400 text-sm">DAO Governed:</span>
              <div className="text-green-400 text-sm font-medium mt-1">✓ Active</div>
            </div>
          </div>
        </div>
      </CardContent>
