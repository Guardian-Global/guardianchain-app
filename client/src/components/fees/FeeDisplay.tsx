...
export default function FeeDisplay({ 
  ...
  return (
    <Card className={`bg-gradient-to-br from-slate-800/90 to-slate-900/90 border-yellow-500/30 shadow-lg shadow-yellow-500/10 ${className}`}>
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-white text-lg font-bold">{justification.title}</span>
      ...
      <CardContent className="space-y-4">
        ...
        {userBalance && (
          <div className="flex items-center justify-between p-3 bg-slate-700/30 rounded-lg">
            <span className="text-slate-300 font-medium">Your GTT Balance:</span>
            <div className="flex items-center gap-2">
              <span className="text-white font-bold text-lg">{formatGTTAmount(userBalance)} GTT</span>
              <Badge variant={hasSufficientFunds ? "default" : "destructive"} className="ml-2">
        ...
        {showDetails && (
          <div className="border-t border-slate-600 pt-4 space-y-4">
            <div className="bg-slate-700/20 p-4 rounded-lg">
              ...
              <p className="text-sm text-slate-300 leading-relaxed">{justification.description}</p>
            </div>
        ...
        <div className="text-center p-3 bg-slate-700/20 rounded-lg">
          <p className="text-xs text-slate-400 leading-relaxed">
            💰 All fees support GuardianChain ecosystem development<br/>
