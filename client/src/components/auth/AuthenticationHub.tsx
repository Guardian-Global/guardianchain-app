              ...
              <Card className="bg-slate-800">
                ...
                <CardContent className="space-y-4">
                  {AUTH_PROVIDERS.map((provider) => {
                    const IconComponent =
                      PROVIDER_ICONS[
                        provider.id as keyof typeof PROVIDER_ICONS
                      ];
                    return (
                      <div
                        key={provider.id}
                  ...
                  >
                    Configure Security ({selectedProviders.length} methods
                    selected)
                  </Button>
                </CardContent>
              </Card>
                  ...
                  {aiRecommendations ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-slate-300 space-y-1">
                          {aiRecommendations.nextSteps?.map(
          ...
          <TabsContent value="verification">
            <div className="grid md:grid-cols-3 gap-6">
              {selectedProviders.map((providerId) => {
                ...
                const IconComponent =
                  PROVIDER_ICONS[providerId as keyof typeof PROVIDER_ICONS];
            ...
            <Card className="bg-slate-800">
              <CardHeader className="text-center">
                ...
                <p className="text-slate-300">
                  Personalized setup recommendations based on your goals and
                  tier selection
                </p>
              </CardHeader>
              <CardContent>
