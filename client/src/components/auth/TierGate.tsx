...
export function TierGate({ requiredTier, children, fallbackMessage }: TierGateProps) {
  ...
  const requiredTierLevel = TIER_HIERARCHY[requiredTier as keyof typeof TIER_HIERARCHY] || 1;
  ...
  return (
    <Card className="bg-slate-800/50 border-slate-700 max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          {fallbackMessage || `This feature requires ${requiredTier} tier or higher`}
        </CardDescription>
      </CardHeader>
