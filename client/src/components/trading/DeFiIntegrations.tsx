      ...
      <Card className="bg-slate-900 border-slate-800">
        <CardHeader>
          ...
          <p className="text-slate-400">
            Deep liquidity pools, yield farming, and DeFi strategies for
                  ...
                  <div key={index} className="p-4 bg-slate-800 rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <div
                            className={`w-2 h-2 rounded-full ${getRiskColor(farm.risk).replace("text-", "bg-")}`}
                          />
                          <span
                            className={`text-xs ${getRiskColor(farm.risk)}`}
                          >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-slate-400">
                          {farm.lockPeriod === "None"
                            ? "Flexible withdrawal"
                            : `Locked for ${farm.lockPeriod}`}
                        </span>
                      </div>
                      <Button size="sm">Stake GTT</Button>
                    </div>
                  </div>
                ))}
              </div>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-2 h-2 rounded-full ${getStatusColor(protocol.status)}`}
                              />
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-lg border border-green-500/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-green-400 font-medium">
                Institutional DeFi Program
              </span>
            </div>
            <p className="text-sm text-slate-300 mb-3">
              Join our institutional DeFi program for priority pool access,
              reduced fees, and dedicated liquidity management support for
              holdings &gt; $1M.
            </p>
