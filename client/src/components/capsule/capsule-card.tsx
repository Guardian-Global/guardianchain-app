              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-slate-400">Creator #{capsule.creatorId}</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <Coins className="h-4 w-4 text-amber-400" />
                    <span className="text-amber-400 font-medium">+{capsule.gttReward} GTT</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <MessageCircle className="h-4 w-4 text-slate-500" />
                    <span className="text-slate-400">{capsule.verificationCount}</span>
                  </div>
                </div>
    ...
    <Card className="bg-slate-800/50 border-slate-700 hover:border-slate-600 transition-all duration-300 card-hover overflow-hidden group">
      <div className="aspect-video bg-slate-700 overflow-hidden relative">
        ...
        <div className="absolute top-3 right-3">
          <Badge variant="outline" className="border-slate-600 text-slate-300 bg-slate-900/80 backdrop-blur-sm">
            {capsule.category}
          </Badge>
        </div>
      </div>
      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center space-x-1">
            <Coins className="h-4 w-4 text-amber-400" />
            <span className="text-amber-400 font-medium text-sm">+{capsule.gttReward} GTT</span>
          </div>
        </div>
