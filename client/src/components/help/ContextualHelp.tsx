...
export interface HelpContent {
  ...
  category: 'capsule' | 'verification' | 'token' | 'analytics' | 'security' | 'general';
}
...
const HELP_CONTENT_DATABASE: Record<string, HelpContent> = {
  'capsule-creation': {
    ...
    description: 'Truth capsules are immutable containers for verified information. They serve as the foundation of the GUARDIANCHAIN truth verification ecosystem.',
    steps: [
  ...
  'verification-process': {
    ...
    description: 'The verification process ensures truth accuracy through community consensus and expert review.',
    steps: [
  ...
  'gtt-rewards': {
    ...
    description: 'Earn GTT tokens for creating verified content, participating in verification, and contributing to platform growth.',
    steps: [
  ...
  'privacy-controls': {
    ...
    description: 'Advanced privacy settings allow you to control who can access your content and under what conditions.',
    steps: [
  ...
  'analytics-dashboard': {
    ...
    description: 'Comprehensive analytics help you understand capsule performance, audience engagement, and earning potential.',
    steps: [
        ...
        <div className={`absolute z-50 ${positionClasses[position]} ${sizeClasses[size]}`}>
          <Card className="bg-slate-800/95 border-slate-700 backdrop-blur-sm shadow-xl">
            ...
            <CardContent className="space-y-4">
              ...
              {content.steps && (
                <div>
                  <h4 className="text-white font-medium text-sm mb-2">How to use:</h4>
              ...
              {content.relatedFeatures && (
                <div>
                  <h4 className="text-white font-medium text-sm mb-2">Related features:</h4>
...
export const QuickHelp: React.FC<{ helpId: string; position?: 'top' | 'bottom' | 'left' | 'right' }> = ({
  helpId,
  position = 'top'
}) => {
