  ...
  const valueMultipliers = [
    {
      ...
      multiplier: "1000x",
      description:
        "Automated fact-checking reducing manual verification costs by 99.9%",
    ...
    },
    {
      ...
      multiplier: "200x",
      description:
        "Direct protocol revenue participation for enterprise partners",
      ...
      <Card className="bg-gradient-to-r from-yellow-900/20 to-purple-900/20 border-yellow-500/30">
          ...
          <CardTitle className="text-white flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <div className="text-lg text-yellow-400">
                Unlock Billion-Dollar Protocol Value
              </div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-center text-slate-300 mb-6">
            Transform your organization with enterprise-grade truth verification
            infrastructure. Save millions annually while earning substantial GTT
            rewards.
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">
                Earn substantial GTT tokens through premium subscriptions and
                enterprise usage
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">
                Stake GTT tokens for additional yield and governance voting
                power
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-300 text-sm">
                Receive direct protocol revenue sharing through GTT token
                holdings
              </p>
            </div>
          </div>
