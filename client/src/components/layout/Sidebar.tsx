...
export default function Sidebar({
              ...
              <li key={route.path}>
                ...
                >
                  ...
                  {badge && (
                    <Badge
                      variant="secondary"
                      className="text-xs bg-brand-accent text-white"
                    >
                      {badge}
                    </Badge>
                  )}
  ...
  return (
    <div
      className={`w-80 bg-brand-secondary border-r border-brand-surface h-full flex flex-col ${mobile ? "w-full" : "hidden md:flex"}`}
    >
      {/* Header */}
      <div className="p-6 border-b border-brand-surface">
        <h1 className="text-xl font-bold text-brand-light font-brand">
          GuardianChain
        </h1>
