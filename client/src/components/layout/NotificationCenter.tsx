...
const mockNotifications: Notification[] = [
  {
    ...
    message: 'Your truth capsule "Corporate Whistleblower Report" has been verified by the community.',
  ...
  },
  {
    ...
    message: 'You have earned 12.5 GTT tokens from your staked capsules. Claim your rewards now.',
  ...
  },
  {
    ...
    message: 'New capsule requires your validation input as a community moderator.',
    timestamp: '1 day ago',
    read: true,
  ...
  },
  {
    ...
    message: 'New governance proposal: "Platform Fee Reduction" is now open for voting.',
