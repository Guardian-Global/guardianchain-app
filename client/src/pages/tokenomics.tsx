...
export default function TokenomicsPage() {
  const [activeTab, setActiveTab] = useState<'overview' | 'distribution' | 'staking' | 'metrics'>('overview');
  ...
  const distributionData = [
    { label: 'Community Rewards', percentage: data.distribution.community, color: 'bg-blue-500', description: 'Yield generation, governance participation, and platform activities' },
    { label: 'Team & Development', percentage: data.distribution.team, color: 'bg-green-500', description: '4-year vesting schedule with 1-year cliff' },
    { label: 'Ecosystem Growth', percentage: data.distribution.ecosystem, color: 'bg-purple-500', description: 'Partnerships, integrations, and platform expansion' },
    { label: 'Strategic Investors', percentage: data.distribution.investors, color: 'bg-orange-500', description: 'Seed and Series A funding rounds' },
    { label: 'Treasury Reserve', percentage: data.distribution.treasury, color: 'bg-red-500', description: 'Emergency fund and long-term sustainability' },
    { label: 'Staking Rewards', percentage: data.distribution.staking, color: 'bg-yellow-500', description: 'Additional rewards for token staking' }
  ];
  ...
  const stakingTiers = [
    ...
    },
    {
      ...
      apy: '15%',
      benefits: ['Governance proposals', 'Treasury access', 'White-glove support'],
      color: 'gold'
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto">
            Discover the economic model powering GuardianChain's truth preservation ecosystem. 
            Sustainable, deflationary, and community-driven.
          </p>
        </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className={`text-sm ${getColorClasses(metric.color).split(' ')[0]}`}>
                          {metric.change}
                        </p>
                      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-4">Value Accrual</h3>
                    <ul className="space-y-3">
                      <li className="flex items-center">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Progress value={(data.circulatingSupply / data.totalSupply) * 100} className="h-2" />
                  <div className="flex justify-between text-sm text-gray-500">
                    <span>Circulating: {(data.circulatingSupply / 1000000).toFixed(0)}M GTT</span>
                    <span>Remaining: {((data.totalSupply - data.circulatingSupply) / 1000000).toFixed(0)}M GTT</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                          25% of total supply with 4-year linear vesting and 1-year cliff
                        </p>
                      ...
                      <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                          40% distributed over 5 years based on platform activity
                        </p>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {stakingTiers.map((tier, index) => (
                    <Card key={index} className={`border-2 hover:scale-105 transition-all ${
                      tier.color === 'gold' ? 'border-yellow-300 bg-yellow-50 dark:bg-yellow-900/20' :
                      tier.color === 'purple' ? 'border-purple-300 bg-purple-50 dark:bg-purple-900/20' :
                      tier.color === 'blue' ? 'border-blue-300 bg-blue-50 dark:bg-blue-900/20' :
                      ...
                      <CardHeader className="text-center">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">{tier.minStake}</div>
                      </CardHeader>
                      <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium mb-2">Stake Amount (GTT)</label>
                      <input 
                        type="number" 
                        placeholder="10000"
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-2">Staking Period</label>
                  ...
                  <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <h3 className="text-lg font-semibold mb-4">Projected Rewards</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">24h Price Change</div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Staked Supply</div>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500">Active participation in DAO decisions</div>
                  </div>
                  
                  <div className="text-center">
                    <div className="text-3xl font-bold text-green-500 mb-2">35%</div>
                    <div className="text-sm font-medium">Platform Fees</div>
                    <div className="text-xs text-gray-500">Verification, minting, premium features</div>
                  </div>
                  
                  <div className="text-center">
                    <div className="text-3xl font-bold text-purple-500 mb-2">20%</div>
                    <div className="text-sm font-medium">Yield Generation</div>
                    <div className="text-xs text-gray-500">Staking rewards and grief score bonuses</div>
                  </div>
                </div>
              </CardContent>
            </Card>
