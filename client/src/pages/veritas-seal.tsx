      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 mb-6">
            Official cryptographic notarization of digital truth capsules —
            provably timestamped and identity-sealed
          </p>
            ...
            {sealTypes.map((seal, index) => (
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    {seal.name === "Standard Seal"
                      ? "Start Free Seal"
                      : "Upgrade to " + seal.name}
                  </Button>
                </CardContent>
              </Card>
            ))}
        ...
        <Card className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-purple-500/30">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-slate-300 mb-6">
              Create legally admissible, immutable proof of your capsule's
              authenticity
            </p>
            ...
            <div className="mt-6 p-4 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
              <div className="flex items-center justify-center space-x-3">
                ...
                <p className="text-yellow-400 text-sm">
                  Veritas Seals create permanent, immutable records. Ensure all
                  information is accurate before sealing.
                </p>
              </div>
            </div>
          </CardContent>
