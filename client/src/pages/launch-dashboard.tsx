            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {launchPhases.map((phase, index) => (
                <div key={index} className="p-4 bg-slate-700/30 rounded-lg">
                  ...
                  <p className="text-slate-400 text-xs mt-1 capitalize">{phase.status}</p>
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-gradient-to-r from-green-900/30 to-blue-900/30 border-green-500/30">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-green-400">{revenueMetrics.currentPrice}</div>
          ...
          <Card className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border-purple-500/30">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-purple-400">{revenueMetrics.marketCap}</div>
          ...
          <Card className="bg-gradient-to-r from-blue-900/30 to-cyan-900/30 border-blue-500/30">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-blue-400">{revenueMetrics.volume24h}</div>
          ...
          <Card className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border-yellow-500/30">
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-yellow-400">{revenueMetrics.founderRevenue}</div>
          ...
          <CardContent>
            <div className="space-y-6">
              {exchangeListings.map((tier, index) => (
                <div key={index} className="p-4 bg-slate-700/30 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-white font-bold">{tier.tier} Exchanges</h3>
                    <Badge className={`
                  ...
                  <div className="mb-3">
                    <p className="text-slate-300 mb-2">{tier.exchanges.join(", ")}</p>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-slate-400">Status: {tier.status}</span>
                      <span className="text-blue-400">ETA: {tier.timeframe}</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-pink-400">{viralMetrics.socialMentions}</div>
                <p className="text-slate-300 text-sm">Social Mentions</p>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-400">{viralMetrics.twitterFollowers}</div>
                <p className="text-slate-300 text-sm">Twitter Followers</p>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-400">{viralMetrics.telegramMembers}</div>
                <p className="text-slate-300 text-sm">Telegram Members</p>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-400">{viralMetrics.tiktokViews}</div>
