...
export default function FOMOCountdown() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setTimeLeft(prev => {
        ...
        if (newTime < 3600) { // Last hour
          setPriceIncrease(25);
        } else if (newTime < 10800) { // Last 3 hours
          setPriceIncrease(15);
        } else if (newTime < 21600) { // Last 6 hours
          setPriceIncrease(10);
        } else {
          setPriceIncrease(5);
        }
  ...
  const urgencyLevel = timeLeft < 3600 ? 'CRITICAL' : timeLeft < 10800 ? 'HIGH' : timeLeft < 21600 ? 'MEDIUM' : 'LOW';
  const urgencyColor = urgencyLevel === 'CRITICAL' ? 'red' : urgencyLevel === 'HIGH' ? 'orange' : urgencyLevel === 'MEDIUM' ? 'yellow' : 'green';

  return (
    <div className={`min-h-screen bg-gradient-to-br from-${urgencyColor}-900 via-black to-red-900 text-white`}>
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8">
          <div className="bg-red-600/20 border border-red-500 rounded-lg p-6 mb-6">
            ...
            <div className="text-red-200 text-xl">
              After this timer expires, GTT price increases {priceIncrease}% PERMANENTLY
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className={`bg-gradient-to-r from-${urgencyColor}-600/30 to-red-600/30 border-${urgencyColor}-500`}>
            <CardContent className="pt-6 text-center">
              <Clock className={`w-8 h-8 text-${urgencyColor}-400 mx-auto mb-2`} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <CardContent className="space-y-4">
              <div className="bg-red-600/20 p-4 rounded-lg">
                ...
                <div className="text-white">
                  After timer expires, GTT price increases {priceIncrease}% and locks for 6 months minimum
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Price in {formatTime(timeLeft)}:</span>
              ...
              >
                ...
                BUY NOW - SAVE ${((0.0075 * (priceIncrease / 100)) * 1000).toFixed(2)}
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-900/50 to-black border-orange-500">
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  { user: "0x742d...9A6C", amount: "50,000 GTT", saved: "$187.50", time: "2 sec ago" },
                  { user: "0x959C...39db", amount: "25,000 GTT", saved: "$93.75", time: "8 sec ago" },
                  { user: "0x8c7C...0a73", amount: "100,000 GTT", saved: "$375.00", time: "15 sec ago" },
                  { user: "0x1234...5678", amount: "75,000 GTT", saved: "$281.25", time: "23 sec ago" },
                  { user: "0x9876...4321", amount: "30,000 GTT", saved: "$112.50", time: "31 sec ago" }
                ].map((purchase, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-orange-600/10 rounded-lg">
                    <div>
              ...
              <div className="mt-4 p-3 bg-red-600/20 rounded-lg">
                <div className="text-red-300 text-sm flex items-center">
                  ...
                  {buyersCount} people bought GTT in last hour to avoid price increase
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="bg-gradient-to-r from-red-600/10 to-black border-red-500">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-2xl text-white mb-6">
              This is mathematically your FINAL OPPORTUNITY to buy GTT at $0.0075
            </p>
            <div className="bg-red-600/20 p-6 rounded-lg mb-6">
              ...
              <div className="text-white text-lg">
                After expiry: +{priceIncrease}% price increase locks for minimum 6 months
              </div>
            </div>
            ...
            >
              ...
              BUY BEFORE {formatTime(timeLeft)} OR PAY {priceIncrease}% MORE FOREVER
            </Button>
          </CardContent>
        </Card>
