      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-2">
            Manage capsule verifications, monitor network activity, and track
            validator earnings
          </p>
        </div>
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-white">
              {validatorStats.totalValidations}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Your validation accuracy places you in the top 5% of all
                validators
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Community members frequently request your validation on
                high-stakes capsules
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm">
                Your 9.2/10 reputation score demonstrates consistent,
