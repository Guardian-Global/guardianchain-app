...
export default function TierAccess() {
  ...
  const tiers: AccessTier[] = [
    {
      ...
      benefits: [
        {
          name: "Basic Truth Capsules",
          description: "Create standard verification capsules",
          icon: Shield,
          available: true,
        },
        {
          name: "Community Verification",
          description: "Peer-reviewed by guardian network",
          icon: Users,
          available: true,
        },
        {
          name: "Basic GTT Rewards",
          description: "Earn tokens for verified content",
          icon: Coins,
          available: true,
        },
        {
        ...
        {
          name: "AI Insights",
          description: "Limited AI-powered recommendations",
          icon: Brain,
          available: false,
        },
        {
          name: "Veritas Sealed",
          description: "Premium verification tier",
          icon: Star,
          available: false,
        },
      ],
    ...
    },
    {
      ...
      benefits: [
        {
          name: "Enhanced Truth Capsules",
          description: "Advanced verification features",
          icon: Shield,
          available: true,
        },
        {
          name: "Priority Verification",
          description: "Faster community review process",
          icon: Users,
          available: true,
        },
        {
          name: "1.5x GTT Rewards",
          description: "Bonus multiplier on all earnings",
          icon: Coins,
          available: true,
        },
        {
        ...
        },
        {
          ...
          description: "Create specialized capsule types",
          icon: CheckCircle,
          available: true,
        },
        {
          name: "Veritas Sealed",
          description: "Access to premium verification",
          icon: Star,
          available: false,
        },
      ],
    ...
    },
    {
      ...
      benefits: [
        ...
        },
        {
          ...
          description: "Professional validator review",
          icon: Users,
          available: true,
        },
        {
          name: "2x GTT Rewards",
          description: "Double earnings on all content",
          icon: Coins,
          available: true,
        },
        {
          name: "AI Insights Elite",
        ...
        {
          name: "Veritas Sealed",
          description: "Ultimate truth verification",
          icon: Star,
          available: true,
        },
      ],
    ...
    },
    {
      ...
      benefits: [
        {
          name: "Unlimited Capsules",
          description: "No restrictions on creation",
          icon: Shield,
          available: true,
        },
        {
          name: "Instant Verification",
          description: "Priority processing guarantee",
          icon: Users,
          available: true,
        },
        {
  ...
  const currentTier =
    tiers.find(
      (t) => t.id === ((user as any)?.tier?.toLowerCase() || "explorer"),
    ) || tiers[0];
  const selectedTierData =
    tiers.find((t) => t.id === selectedTier) || currentTier;
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Unlock advanced features and higher GTT rewards as you progress
            through our verification tiers
          </p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Level {currentTier.level} Guardian
                      </CardDescription>
                    </div>
                  </div>
                  <Badge
                    className={`bg-${currentTier.color.split("-")[1]}-600/20 ${currentTier.color} border-${currentTier.color.split("-")[1]}-500/30`}
                  >
                    Active
                  </Badge>
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="ml-2 text-white">
                        {currentTier.limits.capsulesPerMonth === -1
                          ? "Unlimited"
                          : currentTier.limits.capsulesPerMonth}
                      </span>
                    </div>
                    <div>
                      ...
                      <span className="ml-2 text-white">
                        {currentTier.limits.verificationsPerDay === -1
                          ? "Unlimited"
                          : currentTier.limits.verificationsPerDay}
                      </span>
                    </div>
                    <div>
                      <span className="text-gray-400">AI Insights:</span>
                      <span className="ml-2 text-white">
                        {currentTier.limits.aiInsights === -1
                          ? "Unlimited"
                          : `${currentTier.limits.aiInsights}/month`}
                      </span>
                    </div>
                    <div>
              ...
              >
                <CardHeader className="text-center">
                  <div className="flex justify-center mb-2">
                    <div
                      className={`p-3 bg-slate-700/50 rounded-lg ${isCurrent ? "ring-2 ring-green-500/30" : ""}`}
                    >
            ...
            <CardHeader>
              <div className="flex items-center gap-3 mb-4">
                <selectedTierData.icon
                  className={`h-8 w-8 ${selectedTierData.color}`}
                />
                <div>
                  <CardTitle className="text-2xl">
                    {selectedTierData.name} Tier Benefits
                  </CardTitle>
                  <CardDescription>
                    Complete feature breakdown and access levels
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardContent>
              ...
              {selectedTierData.id !== currentTier.id && (
                <div className="mt-8 text-center">
                  ...
                  >
                    <Link href="/pricing">
                      {selectedTierData.level > currentTier.level
                        ? "Upgrade"
                        : "Change"}{" "}
                      to {selectedTierData.name}
          ...
          <Card className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30 max-w-2xl mx-auto">
            <CardContent className="p-8">
              ...
              <p className="text-gray-300 mb-6">
                Higher tiers unlock increased GTT rewards, advanced AI features,
                and premium verification options.
              </p>
