...
import { Shield, Plus, Play, Star, User, Coins, Check, Clock } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-20 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-secondary/10 rounded-full filter blur-3xl animate-pulse-slow" style={{ animationDelay: "1s" }}></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Link href="/create">
                <Button size="lg" className="gradient-primary hover:from-primary/90 hover:to-secondary/90 px-8 py-4 text-lg font-semibold transform hover:scale-105 transition-all duration-200 shadow-lg">
      ...
      <section className="py-20 bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Featured Capsules</h2>
              <p className="text-slate-400 text-lg">Trending truth capsules with high verification scores</p>
            </div>
            <div className="flex space-x-2">
              <Button variant="default" size="sm">Trending</Button>
              <Button variant="outline" size="sm" className="border-slate-600 hover:border-slate-400">Recent</Button>
              <Button variant="outline" size="sm" className="border-slate-600 hover:border-slate-400">Verified</Button>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How Veritas Works</h2>
      ...
      <section className="py-20 bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">GTT Token Economics</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-gradient-to-br from-amber-900/20 to-amber-800/20 border-amber-700/50">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-amber-400">TruthYield</h3>
                <p className="text-slate-300 text-sm">Earn ongoing rewards from verified capsules through our replay-based yield system</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-emerald-900/20 to-emerald-800/20 border-emerald-700/50">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-emerald-400">Governance</h3>
                <p className="text-slate-300 text-sm">Vote on protocol upgrades, dispute resolutions, and ecosystem improvements</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-primary/20 to-primary/10 border-primary/50">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-primary">Staking</h3>
                <p className="text-slate-300 text-sm">Stake GTT to increase your verification power and earn additional rewards</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-900/20 to-purple-800/20 border-purple-700/50">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-slate-300 text-sm">Access premium features, advanced analytics, and exclusive verification tools</p>
              </CardContent>
            </Card>
          </div>
        </div>
