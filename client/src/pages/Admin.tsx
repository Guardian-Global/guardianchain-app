                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b pb-2">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Guardian Capsule #15742</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between border-b pb-2">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">30 GTT to user_abc123</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between border-b pb-2">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Capsule approved for publication</p>
                    </div>
        ...
        <TabsContent value="system" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Platform settings and configuration options</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <code className="bg-gray-100 px-2 py-1 rounded">0x0000...0000</code>
                    </div>
                    <div className="flex justify-between">
