...
export default function OnboardingPage() {
  ...
  const loadStepRecommendations = async () => {
    try {
      const recommendations = await enterpriseAuth.getOnboardingRecommendations(
        currentStep,
        {
          profile,
          preferences,
          ...
          <Card className="bg-slate-800">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    setPreferences((prev) => ({ ...prev, useCase: value }))
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    <SelectItem value="content-protection">
                      Content Protection
                    </SelectItem>
                    <SelectItem value="idea-verification">
                      Idea Verification
                    </SelectItem>
                    <SelectItem value="legal-documentation">
                      Legal Documentation
                    </SelectItem>
                    <SelectItem value="research-validation">
                      Research Validation
                    </SelectItem>
                    <SelectItem value="brand-protection">
                      Brand Protection
                    </SelectItem>
                    <SelectItem value="data-monetization">
                      Data Monetization
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    setPreferences((prev) => ({ ...prev, teamSize: value }))
                  }
                >
                  <SelectTrigger>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  {["GDPR", "CCPA", "HIPAA", "SOX", "PCI DSS", "ISO 27001"].map(
                    (compliance) => (
                      <div
                        key={compliance}
              ...
              <div>
                <Label htmlFor="security-preferences">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="ai-assistance">
                  Enable AI-powered recommendations and analysis
                </Label>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-slate-700 p-4 rounded-lg">
                ...
                <div className="text-sm text-slate-300 space-y-1">
                  <p>
                    <strong>Industry:</strong> {preferences.industry}
                  </p>
                  <p>
                    <strong>Use Case:</strong> {preferences.useCase}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    {preferences.complianceNeeds.join(", ") || "None selected"}
                  </p>
                  <p>
                    <strong>Integrations:</strong>{" "}
                    {preferences.integrations.length} platforms
                  </p>
                </div>
              </div>
            </CardContent>
    ...
    <div className="min-h-screen bg-slate-900 text-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 mb-6">
            Let's set up your enterprise verification platform
          </p>
