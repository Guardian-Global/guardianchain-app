              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-3 rounded-lg bg-slate-700/30">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-slate-400">
                      Community validated your capsule
                    </div>
                  </div>
