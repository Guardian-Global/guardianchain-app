  ...
  const specialties = [
    {
      ...
      icon: Brain,
      description:
        "AI bias, algorithmic manipulation, tech censorship, data misuse",
    ...
    },
    {
      ...
      icon: Microscope,
      description:
        "Research fraud, data manipulation, suppressed studies, peer review corruption",
    ...
    },
    {
      ...
      icon: Globe,
      description:
        "International corruption, war crimes, diplomatic misconduct, election interference",
    ...
    },
    {
      ...
      icon: Shield,
      description:
        "Data breaches, surveillance abuse, privacy violations, cyber warfare",
    ...
    },
    {
      ...
      icon: Zap,
      description:
        "Climate data suppression, energy industry cover-ups, green-washing",
      expertise:
        "Climate scientists, energy industry insiders, environmental lawyers",
      reward: "20,000 TRUTH",
      badge: "GLOBAL IMPACT",
    },
    {
      ...
      icon: Database,
      description:
        "Market manipulation, banking fraud, regulatory capture, crypto crimes",
          ...
          <CardContent>
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-white mb-4">
                Earn TRUTH Tokens for Verified Disclosures
              </h3>
              <p className="text-slate-300 text-lg">
                Truth Vault (TRUTH) tokens increase in value as more truth is
                  ...
                  <CardContent className="p-6 text-center">
                    ...
                    <ul className="space-y-2">
                      {level.features.map((feature, index) => (
                        <li
                          key={index}
                          className="text-slate-300 text-sm flex items-center justify-center"
                        >
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-slate-600 rounded-lg p-8 text-center">
                ...
                <p className="text-slate-300 mb-2">
                  Upload documents, data, recordings, or other evidence
                </p>
                <p className="text-slate-400 text-sm">
                  Expert panel will verify authenticity and significance
                </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-blue-400 font-semibold mb-1">
                    Expert Validation Promise
                  </h4>
                  <p className="text-slate-300 text-sm">
                    Your submission will be reviewed by world-class experts in
                    your selected field. Upon verification, you'll receive TRUTH
                    tokens and global platform for your disclosure.
                  </p>
                </div>
              </div>
            </div>
