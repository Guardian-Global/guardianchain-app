...
export default function TruthVaultDashboard() {
  ...
  const recentActivity = [
    {
      action: "Truth Verification",
      user: "0x742d...9A6C",
      reward: "5,000 TRUTH",
      time: "2 min ago",
    },
    {
      action: "Whistleblower Disclosure",
      user: "Anonymous",
      reward: "25,000 TRUTH",
      time: "15 min ago",
    },
    {
      action: "Memory Capsule Minted",
      user: "0x8c7C...F0a73",
      reward: "1,200 TRUTH",
      time: "23 min ago",
    },
    {
      action: "Institutional Verification",
      user: "CourtsAI_Legal",
      reward: "8,500 TRUTH",
      time: "1 hr ago",
    },
    {
      action: "Time-Lock Message",
      user: "0x959C...239db",
      reward: "2,100 TRUTH",
      time: "2 hrs ago",
    },
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="text-center p-6 bg-slate-800/50 rounded-lg">
                ...
                <div className="text-3xl font-bold text-yellow-400">
                  {(tokenMetrics.circulatingSupply / 1000000).toFixed(1)}M
                </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {stakingPools.map((pool, index) => (
              <Card
                key={index}
                className="bg-slate-800/50 border-slate-600 hover:border-purple-500/50 transition-all"
              >
                <CardHeader>
