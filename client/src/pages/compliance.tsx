...
import { runComplianceAudit, getComplianceStatus, logComplianceEvent } from '@/lib/compliance';
      ...
      <section className="pt-20 pb-8 bg-gradient-to-br from-blue-900 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-6">
            AI-powered compliance monitoring and regulatory risk assessment for {BRAND_NAME}
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {status && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <CardContent>
                  <div className="flex items-center">
                    ...
                    <span className={`font-semibold capitalize ${
                      status.riskLevel === 'low' ? 'text-green-400' : 'text-yellow-400'
                    }`}>
                      {status.riskLevel}
                    </span>
                  </div>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-slate-400">Last Audit</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-white flex items-center">
                  <Shield className="w-5 h-5 mr-2" style={{ color: BRAND_COLORS.SUCCESS }} />
              ...
              <div className="bg-slate-700/50 p-6 rounded-lg">
                {loading ? (
                  <div className="flex items-center justify-center py-8">
                    ...
                    <span className="text-slate-300">Running AI compliance audit...</span>
                  </div>
                ) : (
          ...
          <Card className="bg-slate-800/50 border-slate-700 mb-8">
            <CardHeader>
              <CardTitle className="text-white">Manual Compliance Actions</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Monitoring Capabilities</CardTitle>
              </CardHeader>
              <CardContent>
