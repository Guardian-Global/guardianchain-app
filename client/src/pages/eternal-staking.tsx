...
export default function EternalStaking() {
  ...
  const recentActivities = [
    {
      user: "FamilyVault247",
      action: "Staked 500 GTT",
      pool: "100-Year Memory Vault",
      time: "2 mins ago",
    },
    {
      user: "TruthSeeker89",
      action: "Claimed 45 GTT",
      pool: "25-Year Legacy Boost",
      time: "5 mins ago",
    },
    {
      user: "MemoryKeeper",
      action: "Staked 1,250 GTT",
      pool: "50-Year Time Capsule",
      time: "8 mins ago",
    },
    {
      user: "LegacyBuilder",
      action: "Renewed stake",
      pool: "100-Year Memory Vault",
      time: "12 mins ago",
    },
  ];
  ...
  const portfolioData = [
    ...
    }, // No earnings yet
    {
      ...
      change: "+$0 (24h)",
      color: "text-blue-400",
    }, // Zero portfolio value for new user
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
            ...
            <div className="relative rounded-xl overflow-hidden bg-slate-800/50 border border-slate-700">
              ...
              <div className="absolute bottom-3 left-3 right-3">
                <div className="text-white text-sm font-medium">
                  100-Year Staking Process
                </div>
                <div className="text-slate-300 text-xs">
                  See how capsules are sealed and staked for generational
                  returns
                </div>
              </div>
            </div>
          ...
          <h1 className="text-5xl font-bold text-white mb-6">
            ...
            <Badge className="ml-4 bg-yellow-600/20 text-yellow-400">
              YIELD ACTIVE
            </Badge>
          </h1>
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <Badge className={getBadgeColor(pool.badge)}>
                          {pool.badge}
                        </Badge>
                      </div>
                      <div
                        className={`w-12 h-12 bg-gradient-to-br ${getPoolColor(pool.color)} rounded-lg flex items-center justify-center`}
                      >
                  ...
                  {stakingPools.slice(0, 2).map((pool) => (
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        <div
                          className={`w-10 h-10 bg-gradient-to-br ${getPoolColor(pool.color)} rounded-lg flex items-center justify-center`}
                        >
