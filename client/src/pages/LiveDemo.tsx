  ...
  const demoSteps = [
    {
      ...
      description:
        "Submit your memory, testimony, or digital asset for verification",
      icon: Shield,
      status: "completed",
    },
    {
      ...
      description:
        "Advanced AI analyzes content authenticity and generates truth score",
      icon: Brain,
      status: "completed",
    },
    {
    ...
    },
    {
      ...
      description:
        "Receive tokens based on verification success and grief score",
      icon: Coins,
      status: "pending",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Experience the complete truth verification process from capsule
            creation to GTT rewards
          </p>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <Card className="bg-slate-800/50 border-slate-700/50">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Watch how GuardianChain transforms memories into verified
                digital assets
              </CardDescription>
            </CardHeader>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card className="bg-gradient-to-br from-slate-800/50 to-blue-900/20 border-slate-700/50">
            <CardHeader>
              ...
              <CardDescription>
                Ultimate truth verification with blockchain guarantee
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-br from-slate-800/50 to-green-900/20 border-slate-700/50">
            <CardHeader>
              ...
              <CardDescription>
                Earn rewards for truth verification and quality content
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-gray-300">
          ...
          <Card className="bg-gradient-to-br from-slate-800/50 to-purple-900/20 border-slate-700/50">
            <CardHeader>
              ...
              <CardDescription>
                Advanced AI-powered content analysis and insights
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-sm text-gray-300">
          ...
          <Card className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30 max-w-2xl mx-auto">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold mb-4">
                Ready to Start Preserving Truth?
              </h3>
              <p className="text-gray-300 mb-6">
                Join thousands of guardians already earning GTT rewards through
