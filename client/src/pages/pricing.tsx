      ...
      <section className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm text-blue-300">Start earning GTT tokens today</span>
          </div>
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
            Join thousands earning rewards for truth verification. Scale from individual explorer to enterprise deployment.
          </p>
                ...
                >
                  ...
                  <CardContent className="pt-0">
                    ...
                    <Button
                      ...
                      variant={tier.popular || tier.name === 'Explorer' ? 'default' : 'outline'}
          ...
          <div className="space-y-6">
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-300">
                  Create truth capsules that get verified by the community, participate in verification of others' submissions, 
                  and stake your GTT tokens for governance rewards. The more accurate your contributions, the more you earn.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-300">
                  ...
                  at your next billing cycle. All earned GTT tokens remain in your wallet regardless of plan changes.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-300">
                  Professional truth verification suite including Veritas Seal (DocuSign integration), Truth Bounty 
                  (crowdsourced investigations), Truth Redemption (accountability platform), and Conspiracy Capsule 
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-300">
                  Yes, we use blockchain technology for immutable truth verification with advanced privacy controls. 
                  You control who can access your capsules and at what verification level. Enterprise plans include 
                  additional security features and compliance reporting.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900/20 to-purple-900/20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Join the truth verification revolution. Start with Explorer tier and upgrade as you grow.
          </p>
