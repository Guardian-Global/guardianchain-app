      ...
      <section className="pt-8 pb-16 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            >
              Join {liveData.activeUsers.toLocaleString()}+ users earning
              rewards for truth verification. Create capsules, verify content,
              and earn up to {isPremium ? "500" : "10"} GTT tokens monthly.
            </motion.p>
                  ...
                  <div className="flex items-center gap-4 mb-4 md:mb-0">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white">
                        Welcome back,{" "}
                        {user?.firstName || user?.email || "Truth Seeker"}!
                      </h3>
                      <p className="text-slate-400">
                        {tierDisplayName} tier • Earning limit: {gttLimit}{" "}
                        GTT/month
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card className="bg-gradient-to-br from-green-900/20 to-green-800/20 border-green-700/50">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-green-400 text-sm">Verified Today</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-900/20 to-purple-800/20 border-purple-700/50">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-purple-400 text-sm">Active Users</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-amber-900/20 to-amber-800/20 border-amber-700/50">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-amber-400 text-sm">GTT Price</div>
              </CardContent>
            </Card>
          </div>
        </div>
              ...
              >
                ...
                <CardContent className="pt-0">
                  ...
                  <Button
                    ...
                    variant={
                      tierPlan.current || tierPlan.popular
                        ? "default"
                        : "outline"
                    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-400 mb-4">
                  DocuSign-powered legal verification for legally binding truth
                  capsules with enterprise-grade security.
                </p>
                <Badge
                  className={
                    canAccessVeritasTools ? "bg-green-600" : "bg-red-600"
                  }
                >
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-400 mb-4">
                  Crowdsourced investigation rewards with GTT token bounties for
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-6">
                ...
                <p className="text-slate-400 mb-4">
                  Detailed performance insights, verification tracking, and
                  earning optimization reports.
                </p>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Join the truth verification revolution. Create your first capsule
            and start earning GTT tokens today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isAuthenticated ? (
              <>
