...
const mockCapsules: TruthCapsule[] = [
  {
    ...
    description:
      "Comprehensive documentation of global temperature changes with satellite data verification.",
    type: "news-report",
    author: "dr.climate",
    verified: true,
  ...
  },
  {
    ...
    description:
      "Preserving the most important day of my life with immutable blockchain storage.",
  ...
  },
  {
    ...
    description:
      "Protected disclosure regarding financial irregularities at major corporation.",
    type: "whistleblower",
  ...
  },
  {
    ...
    description:
      "Detailed analysis of voting irregularities with photographic evidence.",
    type: "media-evidence",
...
export default function CapsuleBrowser() {
  ...
  const filteredCapsules = (capsules as TruthCapsule[])
    .filter((capsule: TruthCapsule) => {
      ...
      const matchesType =
        selectedType === "all" || capsule.type === selectedType;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Browse thousands of verified truth capsules from guardians around
            the world. Search, filter, and discover immutable truth.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {
                (capsules as TruthCapsule[]).filter(
                  (c: TruthCapsule) => c.verified,
                ).length
              }{" "}
              Verified
            </Badge>
            ...
            >
              {
                (capsules as TruthCapsule[]).filter(
                  (c: TruthCapsule) => c.verificationLevel === "sealed",
                ).length
              }{" "}
              Sealed
            </Badge>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCapsules.map((capsule: TruthCapsule) => {
            const TypeIcon =
              capsuleTypeIcons[capsule.type as keyof typeof capsuleTypeIcons] ||
              Shield;

            return (
              <Card
                key={capsule.id}
                className="bg-slate-800/50 border-slate-700/50 hover:bg-slate-800/70 transition-all duration-200 hover:scale-105 cursor-pointer"
              >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      {getVerificationBadge(
                        capsule.verificationLevel,
                        capsule.verified,
                      )}
                    </div>
                    <div className="text-right">
                      <div
                        className={`text-sm font-bold ${getTruthScoreColor(capsule.truthScore)}`}
                      >
                        {capsule.truthScore}%
                      </div>
          ...
          <Card className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30 mt-8">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Create your own truth capsules, verify others' content, and earn
                GTT rewards for maintaining the integrity of information.
              </p>
