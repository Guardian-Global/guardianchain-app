          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              ...
              <div className="text-xl text-purple-400">
                AI-Powered Content Value Discovery
              </div>
            </div>
          </div>

          <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-8">
            Understand the true value of your ideas and content before sharing
            them publicly. Protect your intellectual property and maximize viral
            potential with AI-powered analysis.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-slate-800/50 rounded-lg p-4 text-center">
              ...
              <div className="text-sm font-semibold text-white">
                Pre-Social Protection
              </div>
              <div className="text-xs text-slate-400">
                Immutable proof before sharing
              </div>
            </div>
            <div className="bg-slate-800/50 rounded-lg p-4 text-center">
          ...
          <CardHeader>
            <CardTitle className="text-white text-center">
              <div className="text-3xl font-bold mb-2">
                Ready to Maximize Your Content Value?
              </div>
              <div className="text-lg text-purple-400">
                Join the GUARDIANCHAIN Protocol
              </div>
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-slate-300 text-sm">
                  Establish immutable proof of creation and ownership before
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300 text-sm">
                  Discover the true value of your content and ideas before
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300 text-sm">
                  Use AI-powered insights to optimize content for maximum
            ...
            <div className="text-center mt-8">
              <div className="bg-gradient-to-r from-purple-600 to-green-600 rounded-lg p-6">
                ...
                <div className="text-sm text-white/60">
                  Join thousands of creators who are maximizing their content
                  value with GUARDIANCHAIN
                </div>
              </div>
            </div>
          </CardContent>
