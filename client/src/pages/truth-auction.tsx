  ...
  const liveAuctions = [
    {
      ...
      description:
        "Verified evidence of accounting fraud with supporting documentation",
      currentBid: "12.5",
      bidders: 47,
      timeLeft: "2h 34m",
      heatIndex: 95,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 mb-6">
            Auction one-of-one capsules containing verified, sealed disclosures.
            Truth has value — let the public bid for access.
          </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {liveAuctions.map((auction, index) => (
              <Card
                key={index}
                className="bg-slate-800/50 border-slate-600 hover:border-red-500/50 transition-all"
              >
                <CardHeader>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          {bidder.bids} bids, {bidder.won} won
                        </p>
                      </div>
                    </div>
        ...
        <Card className="bg-gradient-to-r from-red-900/30 to-orange-900/30 border-red-500/30">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-slate-300 mb-6">
              Stake against suppression, unlock redemptive donations, or let the
              public bid for access to verified truth
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              <div className="p-4 bg-slate-800/50 rounded-lg">
                ...
                <p className="text-slate-400 text-sm">
                  Revenue shared with GTT stakers
                </p>
              </div>
              <div className="p-4 bg-slate-800/50 rounded-lg">
