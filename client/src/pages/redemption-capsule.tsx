...
export default function RedemptionCapsulePage() {
  ...
  const redemptionTypes = [
    {
      ...
      icon: FileText,
      description:
        "Issue a verified public response to allegations in a truth capsule",
      cost: "Free",
    ...
    },
    {
      ...
      icon: ShieldCheck,
      description:
        "Present verified evidence that contradicts or clarifies allegations",
      cost: "$199",
      features: [
        "Expert verification",
        "Forensic analysis",
  ...
  const redemptionProcess = [
    {
      step: 1,
      title: "Reference Original Capsule",
      description: "Identify the truth capsule you wish to respond to",
    },
    {
      step: 2,
      title: "Choose Redemption Type",
      description: "Select response, reconciliation, or counter-evidence",
    },
    {
      step: 3,
      title: "Submit Your Case",
      description: "Provide detailed response with supporting materials",
    },
    {
      step: 4,
      title: "Community Review",
      description: "Independent verification and community assessment",
    },
    {
      step: 5,
      title: "Public Resolution",
      description: "Transparent outcome published to blockchain",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 mb-6">
            If you were named in a Truth Capsule, this page allows you to issue
            a public response, seek reconciliation, or present counter-evidence
          </p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm">
                        "Corporate Misconduct at TechCorp Inc" - Published 3
                        weeks ago
                      </p>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-slate-600 rounded-lg p-8 text-center">
                  ...
                  <p className="text-slate-300 mb-2">
                    Upload documents, recordings, or other evidence
                  </p>
                  <p className="text-slate-400 text-sm">
                    All evidence will be verified by independent experts
                  </p>
              ...
              <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">
                      GUARDIANCHAIN believes every truth should allow for
                      growth. Your response will be fairly reviewed and
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">
                        {redemption.type} • {redemption.time}
                      </p>
                    </div>
                  </div>
        ...
        <Card className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-purple-500/30">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-slate-300 mb-6">
              Our mediation team provides expert guidance through the redemption
              process
            </p>
