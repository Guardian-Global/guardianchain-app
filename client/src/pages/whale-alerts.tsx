      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Real-time alerts when whales move GTT tokens. Follow the smart
            money.
          </p>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Bell
                  className={`w-8 h-8 ${alertsEnabled ? "text-green-400" : "text-slate-400"}`}
                />
                <div>
                  ...
                  <p className="text-slate-400">
                    Get instant alerts for transactions over $10,000
                  </p>
                </div>
              </div>
              <Button
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-slate-400 text-xs">
                          {transaction.timestamp.toLocaleTimeString()} • Impact:{" "}
            ...
            <CardContent className="space-y-4">
              <div className="bg-green-600/20 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  Top 3 whales are accumulating. 73% of large transactions are
                  buys.
                </p>
              </div>
              ...
              <div className="bg-blue-600/20 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  Whale activity precedes 85% of major price movements by 2-4
                  hours.
                </p>
              </div>
              ...
              <div className="bg-purple-600/20 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  When 3+ whales buy within 1 hour, price typically increases
                  12-25%.
                </p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-blue-500/30">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
              Whales have inside information and massive resources. When they
              move, smart money follows. Our algorithm tracks their patterns and
