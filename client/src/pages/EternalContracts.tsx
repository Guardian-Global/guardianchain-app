...
export default function EternalContractsPage() {
  ...
  const createContractMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description:
          "Your immortal declaration has been sealed on the blockchain.",
      });
      setFormData({
        title: "",
        content: "",
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "activated":
        return <Unlock className="w-4 h-4 text-orange-500" />;
      default:
        return <FileText className="w-4 h-4 text-gray-500" />;
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto">
            Create immutable declarations that transcend time. Seal your final
            words, digital wills, and sacred promises for eternity.
          </p>
        </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Associate this contract with your ENS domain for public
                      verification
                    </p>
                  </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            requiresWitness: e.target.checked,
                          }))
                        }
                        className="rounded"
                      />
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {contracts.map((contract) => (
                  <Card
                    key={contract.id}
                    className={`bg-gradient-to-br ${getTypeColor(contract.contractType)} border`}
                  >
                    <CardHeader>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  No Eternal Contracts Yet
                </h3>
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Create your first immortal declaration to preserve your
                  legacy.
                </p>
        ...
        {activeTab === "templates" && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {contractTypes.map((template) => (
              <Card
                key={template.type}
                className={`bg-gradient-to-br ${getTypeColor(template.type)} border hover:scale-105 transition-all cursor-pointer`}
              >
                <CardHeader>
