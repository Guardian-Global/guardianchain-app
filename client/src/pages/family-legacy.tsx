      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-bold text-white mb-6">
            Family Legacy Hub
            <Badge className="ml-4 bg-pink-600/20 text-pink-400">
              GENERATIONAL
            </Badge>
          </h1>
          <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-8">
            Create a living digital inheritance that grows in value across
            generations. Transform family memories into financial legacies that
            tell your story forever.
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="text-center mb-4">
                  ...
                  <p className="text-slate-300 text-sm">
                    Watch how families preserve their memories forever
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  {familyMilestones.map((milestone) => {
                    ...
                    return (
                      <div
                        key={milestone.id}
                        className="flex items-center space-x-6 p-6 bg-slate-700/30 rounded-lg"
                      >
                        <div
                          className={`w-12 h-12 bg-slate-600 rounded-lg flex items-center justify-center`}
                        >
                        ...
                        <div className="text-right">
                          <div className="text-green-400 font-bold text-lg">
                            {milestone.capsuleValue}
                          </div>
                          <div className="text-slate-400 text-sm">
                            Current Value
                          </div>
                          <div className="text-purple-400 text-sm font-medium">
                            {milestone.projectedValue}
                          </div>
                        </div>
              ...
              {legacyPrograms.map((program) => (
                ...
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <Badge className="mt-2 bg-pink-600/20 text-pink-400">
                          {program.badge}
                        </Badge>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    ...
                    <Button className="w-full mt-6 bg-gradient-to-r from-pink-600 to-red-600 hover:from-pink-700 hover:to-red-700">
                      Join Program
                    </Button>
                  </CardContent>
                </Card>
              ...
              <CardContent>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-slate-800/50 rounded-lg">
                        ...
                        <p className="text-slate-400 text-xs mt-1">
                          Current family capsule investments
                        </p>
                      </div>
                      ...
                      <div className="p-4 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-lg border border-blue-500/30">
                        ...
                        <p className="text-slate-400 text-xs mt-1">
                          Hypothetical long-term projection
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4 text-sm">
                      <div className="p-3 bg-slate-800/30 rounded border-l-4 border-blue-500">
                        ...
                        <p className="text-slate-300">
                          Preserved memories with modest growth potential
                        </p>
                      </div>
                      <div className="p-3 bg-slate-800/30 rounded border-l-4 border-green-500">
                        <div className="font-medium text-green-400">
                          Grandchildren (2050-2075)
                        </div>
                        <p className="text-slate-300">
                          Family stories preserved for future generations
                        </p>
                      </div>
                      <div className="p-3 bg-slate-800/30 rounded border-l-4 border-purple-500">
                        <div className="font-medium text-purple-400">
                          Great-Grandchildren (2075-2125)
                        </div>
                        <p className="text-slate-300">
                          Multi-generational memory preservation
                        </p>
                      </div>
                      <div className="p-3 bg-slate-800/30 rounded border-l-4 border-pink-500">
                        ...
                        <p className="text-slate-300">
                          Eternal family memory preservation
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-8 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
                  ...
                  <p className="text-red-300 text-xs leading-relaxed">
                    *All value projections are hypothetical estimates for
                    illustrative purposes only. These projections are NOT
                    financial advice, investment recommendations, or guarantees
                    of future performance. Actual results may vary significantly
                    and could result in loss of principal. Platform primarily
                    provides memory preservation services. Past performance does
                    not predict future results. Consult qualified financial
                    advisors before making investment decisions. This platform
                    is for entertainment and educational purposes.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-gradient-to-r from-pink-900/30 to-red-900/30 border-pink-500/30">
            <CardContent className="p-8">
              ...
              <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
                Preserve your family's precious memories for future generations.
                Create digital time capsules that protect your stories, photos,
                and messages forever. Start building your family's digital
                legacy today.
              </p>
