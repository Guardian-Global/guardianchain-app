      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-slate-800 rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-green-900/30 border border-green-600 rounded p-4">
              <h3 className="text-green-400 font-semibold">✅ Server Running</h3>
              <p className="text-slate-300">Express server on port 5000</p>
            </div>
            <div className="bg-green-900/30 border border-green-600 rounded p-4">
              <h3 className="text-green-400 font-semibold">✅ React Rendering</h3>
        ...
        <div className="bg-slate-800 rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Video Tests */}
            <div className="text-center">
              <h3 className="text-lg font-semibold mb-4">GUARDIANCHAIN Video</h3>
              <video 
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          <p className="text-slate-300 mb-4">
            All your company assets (logos and videos) should now be loading properly. 
            Check the browser console for asset loading status messages.
          </p>
          <div className="bg-slate-700 rounded p-4">
            <p className="text-green-400 font-semibold">✅ Asset Integration Complete</p>
            <p className="text-slate-300">
              Your months of work creating these assets is now fully functional across the platform.
            </p>
          </div>
        </div>
      </div>
