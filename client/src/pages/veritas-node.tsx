      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">
            Veritas Node Network
          </h1>
          
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            Decentralized verification infrastructure powering truth validation across the GuardianChain ecosystem.
          </p>
        </motion.div>
        ...
        >
          <Card className="bg-black/40 border-white/10 backdrop-blur-xl">
            ...
            <CardContent className="p-8 text-center">
              <div className="flex items-center justify-center w-20 h-20 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full mb-6 mx-auto">
              ...
              <p className="text-slate-400 mb-6 leading-relaxed">
                The Veritas Node system will enable distributed truth verification, 
                consensus mechanisms, and automated validation processes. Node operators 
                will earn GTT rewards for maintaining network integrity and processing 
                verification requests across the global truth infrastructure.
              </p>
