    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-slate-300 max-w-2xl mx-auto">
          ...
          Browse verified memories, investigations, and evidence from around the
          world.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-slate-800 border-slate-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-white">
              {explorerData.length.toLocaleString()}
            </div>
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-white">
              {
                explorerData.filter((c) => c.verificationStatus === "verified")
                  .length
              }
            </div>
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-white">
              {
                explorerData.filter((c) => c.verificationStatus === "pending")
                  .length
              }
            </div>
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-white">
              {explorerData
                .reduce((total, c) => total + (c.viewCount || 0), 0)
                .toLocaleString()}
            </div>
