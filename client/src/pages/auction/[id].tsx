...
export default function AuctionViewPage() {
  ...
  const handleUnlock = async () => {
    if (!auction?.encryptedSymmetricKey || !auction?.encryptedContent || !auction?.accessControlConditions) return;
    const plainText = await unlockDisclosure({
      encryptedSymmetricKey: auction.encryptedSymmetricKey,
