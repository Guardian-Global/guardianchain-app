              ...
              <div className="space-y-6">
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-600/20 border border-purple-500/30">
                  ...
                  <span className="text-purple-300 text-sm font-semibold">
                    Enterprise Truth Verification Protocol
                  </span>
                </div>
                ...
                <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed max-w-2xl">
                  GUARDIANCHAIN revolutionizes enterprise truth verification
                  through immutable blockchain technology, AI-powered
                  validation, and community-driven consensus. Protecting $100B+
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Built for Fortune 500 companies requiring immutable proof,
              regulatory compliance, and billion-dollar asset protection
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Military-grade cryptographic evidence that cannot be altered, deleted, or disputed",
                features: [
                  "SHA-256 Encryption",
                  "Polygon Network",
                  "99.99% Uptime",
              ...
              },
              {
                ...
                description:
                  "Advanced machine learning algorithms for real-time fraud detection and content analysis",
                features: [
                  "GPT-4 Integration",
                  "Pattern Recognition",
                  "Instant Validation",
              ...
              },
              {
                ...
                description:
                  "Decentralized validation network of verified experts and industry professionals",
                features: [
                  "Expert Network",
                  "Reputation Scoring",
                  "Stake-Based Voting",
              ...
              },
              {
                ...
                description:
                  "Full regulatory compliance for GDPR, SOX, HIPAA, and international data protection laws",
                features: [
                  "Audit Trails",
                  "Legal Framework",
                  "Compliance Reports",
              ...
              },
              {
                ...
                description:
                  "Cloud-native architecture supporting millions of transactions with sub-second response times",
              ...
              },
              {
                ...
                description:
                  "Worldwide network of truth validators operating across 150+ countries and jurisdictions",
                features: [
                  "24/7 Operations",
                  "Multi-Language",
              ...
              <Card
                key={index}
                className="bg-slate-800/70 border-slate-700 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300 group"
              >
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-slate-300 leading-relaxed">
                  In an era where deepfakes, AI-generated content, and digital
                  manipulation threaten the foundation of trust, GUARDIANCHAIN
                  provides the infrastructure to verify, validate, and protect
                  authentic truth at global scale.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-xl text-slate-300">
                Join Fortune 500 companies already protecting their digital
                assets with GUARDIANCHAIN's revolutionary truth verification
                infrastructure.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-green-600 hover:from-purple-700 hover:to-green-700 text-white px-12 py-4 text-lg"
              >
            ...
            <div className="text-sm text-slate-500 pt-8">
              Trusted by 500+ enterprises • $100B+ in verified assets • 150+
              countries served
            </div>
          </div>
        </div>
