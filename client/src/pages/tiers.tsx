      ...
      <section className="pt-20 pb-8 bg-gradient-to-br from-purple-900 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-6">
            Unlock more capsule mints, higher yield bonuses, and exclusive
            features with GTT token economics
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent>
                <p className="text-slate-300">
                  Earn up to 25% bonus yield on all your capsule verifications
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent>
                <p className="text-slate-300">
                  Access advanced analytics, API endpoints, custom branding, and
                  priority support.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent>
                <p className="text-slate-300">
                  Donate unused mints to support trauma survivors, nonprofits,
                  and public truth initiatives.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            All tier benefits integrate with our Guardian Truth Token (GTT) for
            seamless yield distribution and governance participation.
          </p>
          ...
          <div className="bg-gradient-to-r from-purple-900/50 to-green-900/50 rounded-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-slate-300">
                  Higher tiers receive boosted GTT yields automatically
                  distributed from our smart contract treasury system.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">
                ...
                <p className="text-slate-300">
                  Use earned GTT tokens to participate in {BRAND_NAME} DAO
                  governance and shape platform development.
                </p>
              </div>
            </div>
          </div>
