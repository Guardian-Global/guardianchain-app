            ...
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-3">
                ...
                <Button 
                  variant="outline" 
                  className="w-full border-slate-600"
                  onClick={() => window.location.href = '/blockchain-playground'}
                >
            ...
            <Card className="bg-slate-800 border-slate-700">
              ...
              <CardContent className="space-y-3">
                <Button 
                  variant="outline" 
                  className="w-full border-slate-600"
                  onClick={() => window.location.href = '/professional-homepage'}
                >
                  Homepage Variants
                </Button>
                <Button 
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-300">
                    This page contains development tools, examples, and test components that are only visible to administrators. 
                    Public users see the production-ready revenue-focused pages with real functionality.
                  </p>
                </div>
              </div>
            </CardContent>
