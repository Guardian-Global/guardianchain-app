...
import { Plus, Users, Clock, ThumbsUp, ThumbsDown, CheckCircle, XCircle, Loader2 } from 'lucide-react';
...
export default function Govern() {
  ...
  const mockProposals: Proposal[] = [
    {
      ...
      description: "Proposal to increase the minimum GTT balance required to create proposals from 1000 to 2500 GTT. This will help reduce spam and ensure only committed community members can create proposals.",
    ...
    },
    {
      ...
      description: "Allocate 10% of the community treasury to fund truth verification incentives and researcher grants. This will help grow the ecosystem and improve verification quality.",
    ...
    },
    {
      ...
      description: "Implement new machine learning model for improved truth verification accuracy. This upgrade will enhance the platform's ability to detect misinformation and reward accurate content.",
  ...
  const allProposals = [...mockProposals].sort((a, b) => b.createdAt - a.createdAt);

  const getProposalStatus = (proposal: Proposal) => {
    if (proposal.executed) return { label: "Executed", color: "bg-gray-600" };
    if (Date.now() > proposal.deadline * 1000) return { label: "Ended", color: "bg-red-600" };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Participate in GuardianChain governance through GTT-weighted voting
            </p>
          </div>
        </div>
      </section>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">{allProposals.length}</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-white">
                      {allProposals.filter(p => !p.executed && Date.now() < p.deadline * 1000).length}
                    </p>
                  </div>
              ...
              <DialogContent className="bg-slate-800 border-slate-700">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={isPending || isConfirming || !newProposal.title || !newProposal.description}
            ...
            <Card className="bg-yellow-900/20 border-yellow-700 mb-8">
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-yellow-400 font-semibold">Insufficient GTT Balance</p>
                    <p className="text-yellow-200 text-sm">
                      You need at least 1000 GTT to create proposals. Current balance: {gttBalance ? formatEther(gttBalance) : '0'} GTT
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
            {allProposals.length === 0 ? (
              ...
              allProposals.map((proposal) => {
                ...
                return (
                  <Card key={proposal.id} className="bg-slate-800/50 border-slate-700 hover:border-purple-500 transition-colors">
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge variant="outline" className={`border-current ${result === "Passing" ? "text-green-400" : "text-red-400"}`}>
                              {result}
                            </Badge>
                          </div>
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-slate-300 line-clamp-3">{proposal.description}</p>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-sm text-white">{formatEther(proposal.votesFor)} GTT</span>
                          </div>
                          ...
                          <p className="text-xs text-slate-400 mt-1">{forPercentage.toFixed(1)}%</p>
                        </div>
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-sm text-white">{formatEther(proposal.votesAgainst)} GTT</span>
                          </div>
                          <div className="w-full bg-slate-700 rounded-full h-2">
                            <div 
                          ...
                          <p className="text-xs text-slate-400 mt-1">{againstPercentage.toFixed(1)}%</p>
                        </div>
                      </div>
