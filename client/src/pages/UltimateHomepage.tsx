      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        ...
        <p className="text-2xl md:text-3xl text-white/90 mb-8 max-w-4xl mx-auto leading-relaxed">
          ...
          <span className="text-blue-300">
            Powered by blockchain. Governed by community.
          </span>
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center mb-8">
          <Link href={isAuthenticated ? "/dashboard" : "/onboarding"}>
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-12 py-6 text-xl font-semibold rounded-full shadow-2xl transform hover:scale-105 transition-all"
            >
...
function CoreFeaturesSection() {
  const features = [
    {
      ...
      description:
        "Seal memories, testimonies, and documents with cryptographic verification that lasts forever.",
    ...
    },
    {
      ...
      description:
        "Earn tokens based on your grief score, community engagement, and truth verification activities.",
    ...
    },
    {
      ...
      description:
        "Advanced ML models detect deepfakes, validate authenticity, and ensure content integrity.",
    ...
    },
    {
      ...
      description:
        "Track how truths evolve and influence others through our revolutionary lineage system.",
    ...
    },
    {
      ...
      description:
        "Shape the platform's future through DAO voting and community-driven decision making.",
    ...
    },
    {
      ...
      description:
        "Content stored across IPFS and blockchain ensures accessibility and censorship resistance.",
  ...
  const getColorClasses = (color: string) => {
    const colors = {
      ...
      indigo:
        "from-indigo-500/20 to-indigo-600/20 border-indigo-400/30 text-indigo-400",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Every feature designed to preserve, verify, and monetize truth in
            the digital age.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className={`bg-gradient-to-br ${getColorClasses(feature.color)} border backdrop-blur-sm hover:scale-105 transition-all duration-300`}
            >
              <CardHeader>
                <div className="flex items-center justify-between">
                  <feature.icon
                    className={`w-8 h-8 ${getColorClasses(feature.color).split(" ")[2]}`}
                  />
  ...
  const useCases = [
    {
      ...
      description:
        "Preserve family memories, personal stories, and life experiences for future generations.",
      icon: Heart,
      examples: [
        "Family photo albums",
        "Personal diaries",
    ...
    },
    {
      ...
      description:
        "Safely expose wrongdoing with anonymous, tamper-proof submissions and legal protection.",
      icon: Shield,
      examples: [
    ...
    },
    {
      ...
      description:
        "Create verifiable records of work, achievements, and professional interactions.",
      icon: Trophy,
      examples: [
        "Contract agreements",
        "Performance records",
    ...
    },
    {
      ...
      description:
        "Document important events, cultural practices, and historical moments for posterity.",
      icon: Clock,
      examples: [
        "Cultural traditions",
        "Historical events",
    ...
    <section className="py-24 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            From personal memories to global transparency, GuardianChain serves
            every truth preservation need.
          </p>
        </div>
    ...
    <section className="py-24 bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Built on the most advanced blockchain, AI, and distributed systems
            technologies.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {techStack.map((tech, index) => (
            <Card
              key={index}
              className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border-gray-700/50 backdrop-blur-sm hover:scale-105 transition-all duration-300"
            >
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote:
        "GuardianChain gave my family a way to preserve our grandmother's stories forever. The technology is incredible.",
      author: "Sarah Chen",
    ...
    {
      quote:
        "As a journalist, having an immutable platform for source protection and truth verification is invaluable.",
    ...
    {
      quote:
        "The yield mechanism rewards truth-telling. Finally, a platform that incentivizes authenticity.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border-gray-700/50 backdrop-blur-sm"
            >
    ...
    <section className="py-24 bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-2xl text-white/90 mb-12 max-w-2xl mx-auto">
          Join thousands preserving truth for future generations. Start your
          journey today.
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
          <Link href={isAuthenticated ? "/capsules/create" : "/onboarding"}>
            <Button
              size="lg"
              className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-black px-12 py-6 text-xl font-bold rounded-full shadow-2xl transform hover:scale-105 transition-all"
            >
