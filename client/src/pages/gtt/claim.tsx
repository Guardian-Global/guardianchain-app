...
export default function GTTClaimPage() {
  ...
  const { data: yieldSummary, isLoading: summaryLoading } =
    useQuery<YieldSummary>({
  ...
  const handleSelectAll = () => {
    const claimable =
      claimableRewards?.filter((r) => r.status === "claimable") || [];
    setSelectedRewards(
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Claim your earned GTT tokens from staking, grief score yield, and
            platform activities.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">
                    {yieldSummary?.totalClaimable.toFixed(2)}
                  </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-yellow-600">
                    {yieldSummary?.totalPending.toFixed(2)}
                  </p>
                  <p className="text-xs text-gray-500">GTT Tokens</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">
                    {yieldSummary?.totalClaimed.toFixed(2)}
                  </p>
                  <p className="text-xs text-gray-500">GTT Tokens</p>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {yieldSummary?.currentAPY.toFixed(1)}%
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">
                    Grief Score Multiplier
                  </span>
                  <span className="font-semibold">
                    {yieldSummary?.griefMultiplier.toFixed(2)}x
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-semibold">
                    +{yieldSummary?.stakingBonus.toFixed(1)}%
                  </span>
                </div>
              </div>
              <div>
                <div className="mb-2">
                  <span className="text-gray-600 dark:text-gray-400">
                    Next Yield Distribution
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <Calendar className="w-4 h-4 text-gray-400" />
                  <span className="font-semibold">
                    {yieldSummary?.nextYieldDate
                      ? formatDate(yieldSummary.nextYieldDate)
                      : "TBD"}
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <Button
                  ...
                  disabled={
                    !claimableRewards?.some((r) => r.status === "claimable")
                  }
                >
                ...
                <Button
                  ...
                  disabled={
                    selectedRewards.length === 0 || claimMutation.isPending
                  }
                  className="min-w-32"
                >
                ...
                {claimableRewards.map((reward) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() =>
                        isClaimable && handleSelectReward(reward.id)
                      }
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="text-right">
                            <p className="text-lg font-bold">
                              {reward.amount.toFixed(2)} GTT
                            </p>
                            <div className="flex items-center space-x-2">
                              <div
                                className={`w-2 h-2 rounded-full ${getStatusColor(reward.status)}`}
                              />
                      ...
                      <div className="mt-3 text-xs text-gray-500 space-y-1">
                        <div className="flex justify-between">
                          ...
                          <span>
                            Claimable: {formatDate(reward.claimableAt)}
                          </span>
                        </div>
                        {reward.expiresAt && (
