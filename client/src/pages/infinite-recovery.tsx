      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-bold text-white mb-6">
            ...
            <Badge className="ml-4 bg-blue-600/20 text-blue-400">
              ULTIMATE SECURITY
            </Badge>
          </h1>
          <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-8">
            Your memories are protected by the most advanced recovery system
            ever built. From device loss to civilization collapse - your data
            survives everything.
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="text-center mb-4">
                  <h3 className="text-white font-semibold text-lg mb-2">
                    Infinite Recovery in Action
                  </h3>
                  <p className="text-slate-300 text-sm">
                    See how capsules are sealed with ultimate security for
                    infinite recovery
                  </p>
                </div>
                <div className="relative rounded-lg overflow-hidden">
                  ...
                  <div className="absolute bottom-2 left-2 right-2">
                    ...
                    <div className="text-slate-300 text-xs">
                      47,000+ nodes ensuring infinite recoverability
                    </div>
                  </div>
                </div>
              </CardContent>
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 text-sm">
                            {capsule.type} • {capsule.size} • Protected on{" "}
                            {capsule.nodes} nodes
                          </p>
                        </div>
                      </div>
              ...
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-300 text-lg mb-8 max-w-3xl mx-auto">
                    We guarantee that your memories will survive any conceivable
                    disaster. If we can't recover your data within 24 hours,
                    we'll refund 10x your investment.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 text-sm">
                        Never lost a single byte in 3 years
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-slate-400 text-sm">
                        Most recoveries complete in under 15 minutes
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-green-600/20 border border-green-500/30 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-slate-300 text-sm">
                            All your memory capsules are accessible and verified
