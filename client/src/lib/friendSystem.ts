...
export const mockFriendRequests: FriendRequest[] = [
  {
    ...
    status: 'pending',
    message: 'Hi! I found your truth capsules very insightful. Would love to connect!',
...
export const mockPrivateCapsules = [
  ...
  },
  {
    ...
    content: 'Early results from our clinical trial that pharmaceutical companies don\'t want public yet...',
    griefScore: 91,
    isSealed: false,
    isPrivate: true,
 ...
 * Send friend request
 */
export async function sendFriendRequest(fromUserId: string, toUserId: string, message?: string): Promise<boolean> {
