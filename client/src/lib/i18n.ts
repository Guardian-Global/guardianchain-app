...
export const translations: Record<string, Record<TranslationKey, string>> = {
  en: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. All rights reserved. Digital Sovereignty Secured.",
    "token.gtt": "GTT Token",
    ...
    "launch.description":
      "Guardian Truth Token launching on all major exchanges worldwide",
  ...
  ja: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. 全著作権所有。デジタル主権確保。",
    "token.gtt": "GTTトークン",
    "token.balance": "残高",
    "token.claim": "請求",
    "token.stake": "ステーク",
  ...
  ko: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. 모든 권리 보유. 디지털 주권 보장.",
    "token.gtt": "GTT 토큰",
    "token.balance": "잔액",
    "token.claim": "클레임",
    "token.stake": "스테이킹",
  ...
  es: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. Todos los derechos reservados. Soberanía Digital Asegurada.",
    "token.gtt": "Token GTT",
    "token.balance": "Saldo",
    ...
    "launch.description":
      "Token Guardian Truth lanzándose en todos los principales intercambios mundiales",
  ...
  fr: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. Tous droits réservés. Souveraineté Numérique Sécurisée.",
    "token.gtt": "Token GTT",
    "token.balance": "Solde",
    ...
    "launch.description":
      "Le Token Guardian Truth se lance sur tous les principaux échanges mondiaux",
  ...
  de: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. Alle Rechte vorbehalten. Digitale Souveränität Gesichert.",
    "token.gtt": "GTT Token",
    "token.balance": "Saldo",
    ...
    "launch.description":
      "Guardian Truth Token startet auf allen großen Börsen weltweit",
  ...
  ru: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. Все права защищены. Цифровый Суверенитет Обеспечен.",
    "token.gtt": "Токен GTT",
    ...
    "launch.description":
      "Guardian Truth Token запускается на всех крупных биржах мира",
  ...
  ar: {
    ...
    "footer.copyright":
      "© 2025 GUARDIANCHAIN. جميع الحقوق محفوظة. السيادة الرقمية مؤمنة.",
    "token.gtt": "رمز GTT",
    ...
    "launch.description":
      "رمز Guardian Truth ينطلق في جميع البورصات الرئيسية عالمياً",
