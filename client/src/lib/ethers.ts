...
export function parseEthersAmount(amount: string, decimals: number = 18): string {
  try {
...
export function formatEthersAmount(amount: string, decimals: number = 18, displayDecimals: number = 4): string {
  try {
...
export async function getTransactionReceipt(provider: any, txHash: string, maxRetries: number = 5): Promise<any> {
